...
#region Definitions;
#region #CmdDAerationValves_HMI;

namespace SE.Nereda.Symbols.CmdDAerationValves
{
...
namespace SE.Nereda.Symbols.CmdDAerationValves
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdDAerationValves.GRAPHEventArgs> GRAPH_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.CmdDAerationValves.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #CmdDAerationValves_HMI;
