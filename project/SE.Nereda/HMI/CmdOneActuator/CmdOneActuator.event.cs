...
#region Definitions;
#region #CmdOneActuator_HMI;

namespace SE.Nereda.Symbols.CmdOneActuator
{
...
namespace SE.Nereda.Symbols.CmdOneActuator
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdOneActuator.GRAPHEventArgs> GRAPH_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.CmdOneActuator.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
