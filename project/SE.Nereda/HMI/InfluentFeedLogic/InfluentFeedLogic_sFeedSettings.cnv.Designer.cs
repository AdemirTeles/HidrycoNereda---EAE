...
namespace SE.Nereda.Symbols.InfluentFeedLogic
{
	...
	partial class sFeedSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.drawnButton1.OpenFaceplates.Add(new NxtControl.GuiFramework.OpenFaceplate("fpFeedSettings", NxtControl.GuiFramework.MouseButtonType.Click));
			this.drawnButton1.Pen = new NxtControl.Drawing.Pen("ButtonPen");
			this.drawnButton1.Radius = 4D;
			this.drawnButton1.Text = "Feed Influent Settings";
			...
			this.drawnButton1});
			this.SymbolSize = new System.Drawing.Size(216, 112);
