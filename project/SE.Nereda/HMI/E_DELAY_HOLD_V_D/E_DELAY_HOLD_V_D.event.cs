...
namespace SE.Nereda.Symbols.E_DELAY_HOLD_V_D
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.E_DELAY_HOLD_V_D.DUREventArgs> DUR_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (DUR_Fired != null)
          {
            try
            {
              DUR_Fired(this, new SE.Nereda.Symbols.E_DELAY_HOLD_V_D.DUREventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #E_DELAY_HOLD_V_D_HMI;
