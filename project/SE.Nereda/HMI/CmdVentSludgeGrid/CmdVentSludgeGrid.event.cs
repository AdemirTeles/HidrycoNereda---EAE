...
#region Definitions;
#region #CmdVentSludgeGrid_HMI;

namespace SE.Nereda.Symbols.CmdVentSludgeGrid
{
...
namespace SE.Nereda.Symbols.CmdVentSludgeGrid
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdVentSludgeGrid.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.CmdVentSludgeGrid.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_CNF_SD_SP(SE.Nereda.Symbols.CmdVentSludgeGrid.CNF_SD_SPEventArgs ea)
    {
...
#endregion #CmdVentSludgeGrid_HMI;
