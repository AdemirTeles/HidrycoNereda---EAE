...
#region Definitions;
#region #CmdValvePump_HMI;

namespace SE.Nereda.Symbols.CmdValvePump
{
...
namespace SE.Nereda.Symbols.CmdValvePump
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdValvePump.GRAPHEventArgs> GRAPH_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.CmdValvePump.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
