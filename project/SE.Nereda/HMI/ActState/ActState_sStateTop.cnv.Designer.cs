...
namespace SE.Nereda.Symbols.ActState
{
	...
	partial class sStateTop
	{
		...
		private void InitializeComponent()
		{
			...
			// Mode
			// 
			this.Mode.Bounds = new NxtControl.Drawing.RectF(((float)(24D)), ((float)(16D)), ((float)(50D)), ((float)(16D)));
			...
			this.NeedReset.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 168D, 110D);
