...
namespace SE.Nereda.Symbols.AnalogInput_Status
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			// drawnButton1
			// 
			this.drawnButton1.Bounds = new NxtControl.Drawing.RectF(((float)(12.600000381469727D)), ((float)(9D)), ((float)(10.800000190734863D)), ((float)(46D)));
			this.drawnButton1.Brush = new NxtControl.Drawing.Brush("Transparent");
			this.drawnButton1.Font = new NxtControl.Drawing.Font("Arial", 6F, System.Drawing.FontStyle.Bold);
			...
			// StatusRec
			// 
			this.StatusRec.Bounds = new NxtControl.Drawing.RectF(((float)(9D)), ((float)(8D)), ((float)(18D)), ((float)(48D)));
