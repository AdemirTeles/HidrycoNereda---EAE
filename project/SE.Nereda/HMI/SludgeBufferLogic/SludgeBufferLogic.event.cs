...
namespace SE.Nereda.Symbols.SludgeBufferLogic
{
  partial class sSettingsBtn
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.SludgeBufferLogic.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;

    private event EventHandler<SE.Nereda.Symbols.SludgeBufferLogic.GRAPHEventArgs> GRAPH_Fired;

    private event EventHandler<SE.Nereda.Symbols.SludgeBufferLogic.LEVEL_PVEventArgs> LEVEL_PV_Fired;

    private event EventHandler<SE.Nereda.Symbols.SludgeBufferLogic.HI_HI_LEventArgs> HI_HI_L_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.SludgeBufferLogic.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.SludgeBufferLogic.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","GRAPH_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (LEVEL_PV_Fired != null)
          {
            try
            {
              LEVEL_PV_Fired(this, new SE.Nereda.Symbols.SludgeBufferLogic.LEVEL_PVEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","LEVEL_PV_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 3:
          if (HI_HI_L_Fired != null)
          {
            try
            {
              HI_HI_L_Fired(this, new SE.Nereda.Symbols.SludgeBufferLogic.HI_HI_LEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","HI_HI_L_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_SPEED_SP(SE.Nereda.Symbols.SludgeBufferLogic.SPEED_SPEventArgs ea)
    {
    ...
    public bool FireEvent_RESET_LL_F(SE.Nereda.Symbols.SludgeBufferLogic.RESET_LL_FEventArgs ea)
    {
      object[] _values_ = new object[1];
