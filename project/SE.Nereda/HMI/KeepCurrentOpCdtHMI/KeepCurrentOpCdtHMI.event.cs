...
namespace SE.Nereda.Symbols.KeepCurrentOpCdtHMI
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.KeepCurrentOpCdtHMI.NEED_UPDATEEventArgs> NEED_UPDATE_Fired;

    private event EventHandler<SE.Nereda.Symbols.KeepCurrentOpCdtHMI.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (NEED_UPDATE_Fired != null)
          {
            try
            {
              NEED_UPDATE_Fired(this, new SE.Nereda.Symbols.KeepCurrentOpCdtHMI.NEED_UPDATEEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","NEED_UPDATE_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.KeepCurrentOpCdtHMI.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_UPDATE(SE.Nereda.Symbols.KeepCurrentOpCdtHMI.UPDATEEventArgs ea)
    {
    ...
    public bool FireEvent_ACTIVE_UPDATE(SE.Nereda.Symbols.KeepCurrentOpCdtHMI.ACTIVE_UPDATEEventArgs ea)
    {
      object[] _values_ = new object[1];
