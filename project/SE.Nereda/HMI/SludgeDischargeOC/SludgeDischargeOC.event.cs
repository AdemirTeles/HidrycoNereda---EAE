...
#region Definitions;
#region #SludgeDischargeOC_HMI;

namespace SE.Nereda.Symbols.SludgeDischargeOC
{
...
namespace SE.Nereda.Symbols.SludgeDischargeOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.SludgeDischargeOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.SludgeDischargeOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #SludgeDischargeOC_HMI;
