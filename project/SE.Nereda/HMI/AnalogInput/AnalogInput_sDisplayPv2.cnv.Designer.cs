...
namespace SE.Nereda.Symbols.AnalogInput
{
	...
	partial class sDisplayPv2
	{
		...
		private void InitializeComponent()
		{
			...
			// OpenFp
			// 
			this.OpenFp.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(8D)), ((float)(152D)), ((float)(48D)));
			...
			this.Unit.Location = new NxtControl.Drawing.PointF(88D, 36D);
			this.Unit.Name = "Unit";
			this.Unit.Text = "%";
			// 
			// PvBackGround
			// 
			this.PvBackGround.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(16D)), ((float)(152D)), ((float)(40D)));
			...
			this.PvBackGround.Radius = 10D;
			// 
			// Pv
			// 
			this.Pv.BeginInit();
			this.Pv.DecimalPlacesCount = ((uint)(2u));
			this.Pv.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 16D, 36D);
			...
			// Background
			// 
			this.Background.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(8D)), ((float)(152D)), ((float)(24D)));
			...
			// alarmSAFrame1
			// 
			this.alarmSAFrame1.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(8D)), ((float)(152D)), ((float)(48D)));
			...
			this.iUnit.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 168D, 62D);
			this.iUnit.IsOnlyInput = true;
			this.iUnit.Location = new NxtControl.Drawing.PointF(168D, 62D);
			...
			this.OpenFp,
			this.iUnit});
			this.SymbolSize = new System.Drawing.Size(176, 72);
