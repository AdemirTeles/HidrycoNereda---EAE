...
namespace SE.Nereda.Symbols.AnalogInput
{
	...
	partial class sVertical
	{
		...
		{
			this.AnalogInput = new SE.Nereda.Symbols.AnalogInputBase.sVertical();
			// 
			// AnalogInput
			// 
			...
			this.AnalogInput});
			this.SymbolSize = new System.Drawing.Size(144, 200);

		}
		private SE.Nereda.Symbols.AnalogInputBase.sVertical AnalogInput;
		#endregion
	}
}
