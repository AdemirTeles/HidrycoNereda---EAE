...
namespace SE.Nereda.Symbols.TestActState2
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.TestActState2.STATEEventArgs> STATE_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (STATE_Fired != null)
          {
            try
            {
              STATE_Fired(this, new SE.Nereda.Symbols.TestActState2.STATEEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","STATE_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_CNF_ACT_STATE(SE.Nereda.Symbols.TestActState2.CNF_ACT_STATEEventArgs ea)
    {
