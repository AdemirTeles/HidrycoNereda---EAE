...
namespace SE.Nereda.Faceplates.ToFinalTreatment
{
	...
	partial class fpPID
	{
		...
		{
			this.PID_CTP_003 = new SE.App2CommonProcess.Symbols.PID.sBarPvSpOpHoriz();
			...
			// PID_CTP_003
			// 
			this.PID_CTP_003.BeginInit();
			this.PID_CTP_003.DefaultInstanceName = null;
			this.PID_CTP_003.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 120D, 8D);
			this.PID_CTP_003.DisplayType = SE.App2CommonProcess.SupportClasses.PidDisplayType.PvSpOp;
			this.PID_CTP_003.Instancelayer = SE.App2Base.SupportClasses.InstanceLayer.Base;
			this.PID_CTP_003.MyTagDisplayName = null;
			this.PID_CTP_003.Name = "PID_CTP_003";
			this.PID_CTP_003.SecurityToken = ((uint)(4294967295u));
			this.PID_CTP_003.TagName = "PID_CTP_003";
			this.PID_CTP_003.EndInit();
			// 
			// roundedRectangle1
			// 
		...
		private SE.App2CommonProcess.Symbols.PID.sBarPvSpOpHoriz PID_CTP_003;
