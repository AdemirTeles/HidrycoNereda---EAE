...
namespace SE.Nereda.Faceplates.FlushCdt
{
	...
	/// </summary>
	public partial class fpInfos : NxtControl.GuiFramework.HMIFaceplate
	{
		bool bit1;
		bool bit2;
		bool bit3;
		...
		void REQ_ITEMS_NAME_Fired_EventHandler(object sender, SE.Nereda.Symbols.FlushCdt.REQ_ITEMSEventArgs e)
		{
			...
			freeText5.Text = e.itemsName5;
			freeText6.Text = e.itemsName6;
			freeText7.Text = e.itemsName7;
			freeText8.Text = e.itemsName8;
