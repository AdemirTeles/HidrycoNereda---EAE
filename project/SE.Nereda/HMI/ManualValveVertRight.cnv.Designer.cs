...
{
	/// <summary>
	/// Summary description for ManualValveVertRight.
	/// </summary>
	partial class ManualValveVertRight
	{
		...
		private void InitializeComponent()
		{
			...
			// line8
			// 
			this.line8.EndPoint = new NxtControl.Drawing.PointF(56D, 20D);
			...
			this.line8.StartPoint = new NxtControl.Drawing.PointF(56D, 36D);
			// 
			// line12
			// 
			this.line12.EndPoint = new NxtControl.Drawing.PointF(36D, 28D);
			...
			this.line12.StartPoint = new NxtControl.Drawing.PointF(56D, 28D);
			// 
			// polygon1
			// 
			...
			this.group1.EndInit();
			// 
			// ManualValveVertRight
			// 
			this.Name = "ManualValveVertRight";
