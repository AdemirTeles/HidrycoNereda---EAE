...
namespace SE.Nereda.Symbols.NoCmd
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.NoCmd.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.NoCmd.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_CNF_AIR_GRID(SE.Nereda.Symbols.NoCmd.CNF_AIR_GRIDEventArgs ea)
    {
    ...
    public bool FireEvent_CNF_INF_GRID(SE.Nereda.Symbols.NoCmd.CNF_INF_GRIDEventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_CNF_AIR_GRID_MAN(SE.Nereda.Symbols.NoCmd.CNF_AIR_GRID_MANEventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_CNF_INF_GRID_MAN(SE.Nereda.Symbols.NoCmd.CNF_INF_GRID_MANEventArgs ea)
    {
      object[] _values_ = new object[1];
