...
namespace SE.Nereda.Symbols.Mode
{
	...
	partial class ResetReactor2
	{
		...
		private void InitializeComponent()
		{
			...
			this.Reset_Command.FalseText = "Reset Reactor 2";
			...
			this.Reset_Command.TagName = "ResetReactor2";
			...
			this.Reset_Command.TrueText = "Reset Reactor 2";
			...
			// ResetReactor2
			// 
			this.SecurityToken = ((uint)(4294967191u));
