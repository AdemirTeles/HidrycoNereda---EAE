...
namespace SE.Nereda.Symbols.Mode
{
	...
	partial class ResetReactor1
	{
		...
		private void InitializeComponent()
		{
			...
			this.Reset_Command.DesignMatrix = new NxtControl.Drawing.Matrix2D(1.5D, 0D, 0D, 1.3333333333333333D, 16D, 16D);
			...
			this.Reset_Command.FalseText = "Reset Reactor 1";
			...
			this.Reset_Command.TagName = "ResetReactor1";
			...
			this.Reset_Command.TrueText = "Reset Reactor 1";
			...
			this.Reset_Command});
			this.SymbolSize = new System.Drawing.Size(200, 96);
