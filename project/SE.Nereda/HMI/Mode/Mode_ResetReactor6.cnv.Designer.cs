...
namespace SE.Nereda.Symbols.Mode
{
	...
	partial class ResetReactor6
	{
		...
		private void InitializeComponent()
		{
			...
			this.Reset_Command.FalseText = "Reset Reactor 6";
			...
			this.Reset_Command.TagName = "ResetReactor6";
			...
			this.Reset_Command.TrueText = "Reset Reactor 6";
			...
			this.Reset_Command});
			this.SymbolSize = new System.Drawing.Size(200, 88);
