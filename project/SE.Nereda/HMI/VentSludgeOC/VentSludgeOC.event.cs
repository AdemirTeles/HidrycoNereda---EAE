...
#region Definitions;
#region #VentSludgeOC_HMI;

namespace SE.Nereda.Symbols.VentSludgeOC
{
...
namespace SE.Nereda.Symbols.VentSludgeOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.VentSludgeOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.VentSludgeOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
