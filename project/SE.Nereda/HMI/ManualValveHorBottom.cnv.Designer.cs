...
{
	/// <summary>
	/// Summary description for ManualValveHorBottom.
	/// </summary>
	partial class ManualValveHorBottom
	{
		...
		private void InitializeComponent()
		{
			...
			// line5
			// 
			this.line5.EndPoint = new NxtControl.Drawing.PointF(40D, 36D);
			...
			this.line5.StartPoint = new NxtControl.Drawing.PointF(40D, 16D);
			// 
			// line6
			// 
			this.line6.EndPoint = new NxtControl.Drawing.PointF(48D, 36D);
			...
			this.line6.StartPoint = new NxtControl.Drawing.PointF(32D, 36D);
			// 
			// polygon1
			// 
			this.polygon1.Bounds = new NxtControl.Drawing.RectF(((float)(40D)), ((float)(8D)), ((float)(20D)), ((float)(16D)));
			...
			new NxtControl.Drawing.PointF(60D, 8D),
			new NxtControl.Drawing.PointF(60D, 24D),
			new NxtControl.Drawing.PointF(40D, 16D)});
			// 
			// polygon2
			// 
			this.polygon2.Bounds = new NxtControl.Drawing.RectF(((float)(20D)), ((float)(8D)), ((float)(20D)), ((float)(16D)));
			...
			new NxtControl.Drawing.PointF(20D, 8D),
			new NxtControl.Drawing.PointF(20D, 24D),
			new NxtControl.Drawing.PointF(40D, 16D)});
			// 
			// group1
			// 
			...
			this.group1.EndInit();
			// 
			// ManualValveHorBottom
			// 
			this.Name = "ManualValveHorBottom";
