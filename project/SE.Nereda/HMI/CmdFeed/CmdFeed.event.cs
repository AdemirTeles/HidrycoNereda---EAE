...
namespace SE.Nereda.Symbols.CmdFeed
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdFeed.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.CmdFeed.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_FEED_FLOW_SP(SE.Nereda.Symbols.CmdFeed.FEED_FLOW_SPEventArgs ea)
    {
    ...
    public bool FireEvent_FEED_FLOW_SP_MAN(SE.Nereda.Symbols.CmdFeed.FEED_FLOW_SP_MANEventArgs ea)
    {
      object[] _values_ = new object[1];
