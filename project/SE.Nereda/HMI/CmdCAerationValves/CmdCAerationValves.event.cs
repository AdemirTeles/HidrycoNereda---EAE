...
#region Definitions;
#region #CmdCAerationValves_HMI;

namespace SE.Nereda.Symbols.CmdCAerationValves
{
...
namespace SE.Nereda.Symbols.CmdCAerationValves
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdCAerationValves.GRAPHEventArgs> GRAPH_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.CmdCAerationValves.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #CmdCAerationValves_HMI;
