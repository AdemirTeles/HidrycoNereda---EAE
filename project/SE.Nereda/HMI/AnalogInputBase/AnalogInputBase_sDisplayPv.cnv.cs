...
namespace SE.Nereda.Symbols.AnalogInputBase
{
	...
	/// </summary>
	public partial class sDisplayPv : SE.App2Base.Symbols.SEAppLibHMISymbol,SE.App2CommonProcess.SupportClasses.IPropertiesNotifyChange
	{
...
#region PvBarGraph
		...
		public delegate void OptionalServicesAvailable(NxtControl.Drawing.SizeF frameSize, NxtControl.Drawing.PointF frameLoc, NxtControl.Drawing.PointF meterLoc);
		...
		void OptionalServicesActive()
		{
			if (this.OnOptionalServicesAvailable != null) {
				this.OnOptionalServicesAvailable(alarmSAFrame1.Size, alarmSAFrame1.Location, SMeters1.Location);
			}
		}
