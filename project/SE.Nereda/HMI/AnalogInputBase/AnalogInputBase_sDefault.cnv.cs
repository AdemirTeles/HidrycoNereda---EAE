...
namespace SE.Nereda.Symbols.AnalogInputBase
{
	...
	/// </summary>
	public partial class sDefault : SE.App2Base.Symbols.SEAppLibHMISymbol,SE.App2CommonProcess.SupportClasses.IPropertiesNotifyChange
	{
		...
		public override void UpdateTagDisplayName()
		{
			...
			alarmSAFrame1.Visible = (Instancelayer != InstanceLayer.Top);
		}
		...
		protected override void OnInitializeFaceplate(HMIFaceplate hmiFaceplate)
		{
			...
			SE.Nereda.Faceplates.AnalogInputBase.fpParameter fp2 = hmiFaceplate as SE.Nereda.Faceplates.AnalogInputBase.fpParameter;
			if (fp2 != null)
			{
				fp2.Title = MyTagDisplayName + " Parameter";
		        fp2.DecimalPlacesCount = DecimalPlacesCount;
		        fp2.Unit = Unit.EngineeringValue;
		        fp2.RawUnit = Unit.RawValue;
		        fp2.SecMode = SecMode;
		        fp2.SecParameter = SecParameter;
		        fp2.SecSetpoint = SecSetpoint;
			}
			base.OnInitializeFaceplate(hmiFaceplate);
