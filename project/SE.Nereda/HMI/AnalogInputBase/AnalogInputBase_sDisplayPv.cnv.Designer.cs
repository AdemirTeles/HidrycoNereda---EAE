...
namespace SE.Nereda.Symbols.AnalogInputBase
{
	...
	partial class sDisplayPv
	{
		...
		private void InitializeComponent()
		{
			...
			// alarmSAFrame1
			// 
			this.alarmSAFrame1.Bounds = new NxtControl.Drawing.RectF(((float)(24D)), ((float)(37D)), ((float)(78D)), ((float)(36D)));
			...
			// clickFrame
			// 
			this.clickFrame.Bounds = new NxtControl.Drawing.RectF(((float)(33D)), ((float)(40D)), ((float)(66D)), ((float)(33D)));
			...
			this.SMeters1.AbnormalXOffset = 1D;
			this.SMeters1.AbnormalYOffset = 0D;
			this.SMeters1.BarGraphSize = 62D;
			this.SMeters1.DecimalPlacesCount = ((uint)(2u));
			this.SMeters1.DecimalPlacesCountOut = ((uint)(2u));
			this.SMeters1.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.9936997639036057D, 0D, 0D, 1.0000000000000002D, -1.785791972722599D, -38.000000000000014D);
			this.SMeters1.display = SE.App2Base.Graphics.SMeters.Display.Numeric;
			this.SMeters1.FrameColor = new NxtControl.Drawing.Color("SymStaticIconColor");
			this.SMeters1.LeftOffset = ((uint)(20u));
			...
			this.lblInstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(7D)), ((float)(22D)), ((float)(100D)), ((float)(13D)));
			this.lblInstanceName.Brush = new NxtControl.Drawing.Brush();
			...
			this.lblInstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleRight;
