...
namespace SE.Nereda.Symbols.NeredaReactor
{
	...
	partial class sPhase2
	{
		...
		private void InitializeComponent()
		{
			...
			this.ReactorLogic = new SE.Nereda.Symbols.ReactorLogic.sPhases();
			// 
			// DisplayStatus
			// 
			...
			this.InStatus,
			this.ReactorLogic});
			this.SymbolSize = new System.Drawing.Size(504, 368);

		}
		private NxtControl.GuiFramework.Rectangle DisplayStatus;
		private SE.Nereda.Symbols.ReactorLogic.sPhases ReactorLogic;
