...
namespace SE.Nereda.Symbols.FeedOC
{
...
namespace SE.Nereda.Symbols.FeedOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.FeedOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.FeedOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
