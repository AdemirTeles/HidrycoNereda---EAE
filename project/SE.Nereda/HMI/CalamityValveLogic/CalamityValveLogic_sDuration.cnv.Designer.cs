...
namespace SE.Nereda.Symbols.CalamityValveLogic
{
	...
	partial class sDuration
	{
		...
		private void InitializeComponent()
		{
			...
			this.ValveName.Location = new NxtControl.Drawing.PointF(4D, 18D);
			this.ValveName.Name = "ValveName";
			this.ValveName.Text = "Valve xxx :";
			// 
			// rectangle1
			// 
			this.rectangle1.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(16D)), ((float)(360D)), ((float)(16D)));
			...
			this.OpeningValveDur.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 88D, 15D);
