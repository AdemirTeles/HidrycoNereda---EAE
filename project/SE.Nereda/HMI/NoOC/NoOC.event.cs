...
namespace SE.Nereda.Symbols.NoOC
{
...
namespace SE.Nereda.Symbols.NoOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.NoOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.NoOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
