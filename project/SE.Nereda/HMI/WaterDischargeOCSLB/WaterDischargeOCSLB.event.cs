...
#region Definitions;
#region #WaterDischargeOCSLB_HMI;

namespace SE.Nereda.Symbols.WaterDischargeOCSLB
{
...
namespace SE.Nereda.Symbols.WaterDischargeOCSLB
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.WaterDischargeOCSLB.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.WaterDischargeOCSLB.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #WaterDischargeOCSLB_HMI;
