...
namespace SE.Nereda.Faceplates.EffluentCdt
{
	...
	partial class fpStartCdts
	{
		...
		private void InitializeComponent()
		{
			...
			this.StartCdtName = new NxtControl.GuiFramework.RoundedRectangle();
			...
			// StartCdtName
			// 
			this.StartCdtName.Bounds = new NxtControl.Drawing.RectF(((float)(16D)), ((float)(16D)), ((float)(280D)), ((float)(24D)));
			this.StartCdtName.Brush = new NxtControl.Drawing.Brush(new NxtControl.Drawing.Color(((byte)(245)), ((byte)(245)), ((byte)(245))));
			this.StartCdtName.Font = new NxtControl.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold);
			this.StartCdtName.Name = "StartCdtName";
			this.StartCdtName.Text = "Effluent Start Conditions";
			this.StartCdtName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
			// 
			// freeText1
			// 
			...
			this.drawnButton1.OpenFaceplates.Add(new NxtControl.GuiFramework.OpenFaceplate("fpStopCdts", NxtControl.GuiFramework.MouseButtonType.Click));
			this.drawnButton1.Pen = new NxtControl.Drawing.Pen("ButtonPen");
			this.drawnButton1.Radius = 4D;
			this.drawnButton1.Text = "Stop Cdts";
			...
			this.Title = "Start Conditions";

		}
		private NxtControl.GuiFramework.RoundedRectangle BackGround;
		private NxtControl.GuiFramework.RoundedRectangle StartCdtName;
