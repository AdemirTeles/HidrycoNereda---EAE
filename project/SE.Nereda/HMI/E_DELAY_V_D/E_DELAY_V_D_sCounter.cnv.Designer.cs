...
namespace SE.Nereda.Symbols.E_DELAY_V_D
{
	...
	partial class sCounter
	{
		...
		private void InitializeComponent()
		{
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(8D, 7D);
			...
			this.freeText2.Location = new NxtControl.Drawing.PointF(136D, 7D);
			...
			this.Sp.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.42666666666666664D, 0D, 0D, 1D, 64D, 4D);
			...
			this.Pv.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.42666666666666664D, 0D, 0D, 1D, 192D, 4D);
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(128D, 23D);
			...
			this.line1.StartPoint = new NxtControl.Drawing.PointF(128D, 7D);
			// 
			// group1
			// 
