...
#region Definitions;
#region #MetalDosingOC_HMI;

namespace SE.Nereda.Symbols.MetalDosingOC
{
...
namespace SE.Nereda.Symbols.MetalDosingOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.MetalDosingOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.MetalDosingOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
