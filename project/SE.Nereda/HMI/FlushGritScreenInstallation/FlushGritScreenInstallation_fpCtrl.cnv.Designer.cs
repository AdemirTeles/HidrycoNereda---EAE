...
namespace SE.Nereda.Faceplates.FlushGritScreenInstallation
{
	...
	partial class fpCtrl
	{
		...
		private void InitializeComponent()
		{
			...
			this.TimeFromLastFlush = new SE.Nereda.Symbols.E_DELAY_V_D.sDefault();
			...
			this.freeText11.Text = "Open Valve 016";
			// 
			// State7
			// 
			...
			this.freeText12.Location = new NxtControl.Drawing.PointF(96D, 304D);
			this.freeText12.Name = "freeText12";
			this.freeText12.Text = "Open Valve 002";
			// 
			// freeText23
			// 
			...
			this.TimeFromLastFlush.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 96D, 32D);
			this.TimeFromLastFlush.Name = "TimeFromLastFlush";
			this.TimeFromLastFlush.SecurityToken = ((uint)(4294967295u));
			...
			this.freeText18.Text = "Close Valve 016";
			// 
			// freeText20
			// 
			...
			this.freeText20.Location = new NxtControl.Drawing.PointF(344D, 304D);
			this.freeText20.Name = "freeText20";
			this.freeText20.Text = "Close Valve 002";
			// 
			// State11
			// 
			...
			this.Title = "F Grit Screen Installation";
		...
		private SE.Nereda.Symbols.E_DELAY_V_D.sDefault TimeFromLastFlush;
