...
namespace SE.Nereda.Symbols.FlushGritScreenInstallation
{
  ...
  public class FLUSH_SPEventArgs : System.EventArgs
  {
    ...
    private NxtControl.GuiFramework.Time? TimeFromLastFlush_field = null;
    public NxtControl.GuiFramework.Time? TimeFromLastFlush
    {
       get { return TimeFromLastFlush_field; }
       set { TimeFromLastFlush_field = value; }
    }
...
namespace SE.Nereda.Symbols.FlushGritScreenInstallation
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.FlushGritScreenInstallation.GRAPHEventArgs> GRAPH_Fired;

    private event EventHandler<SE.Nereda.Symbols.FlushGritScreenInstallation.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;

    private event EventHandler<SE.Nereda.Symbols.FlushGritScreenInstallation.RESET_BTNsEventArgs> RESET_BTNs_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.FlushGritScreenInstallation.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","GRAPH_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.FlushGritScreenInstallation.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (RESET_BTNs_Fired != null)
          {
            try
            {
              RESET_BTNs_Fired(this, new SE.Nereda.Symbols.FlushGritScreenInstallation.RESET_BTNsEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","RESET_BTNs_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_FLUSH_SP(NxtControl.GuiFramework.Time TimeFromLastFlush, NxtControl.GuiFramework.Time FlushDuration, System.Single FlushFlowSp)
    {
      return ((IHMIAccessorOutput)this).FireEvent(0, new object[] {TimeFromLastFlush, FlushDuration, FlushFlowSp});
    }
    public bool FireEvent_FLUSH_SP(SE.Nereda.Symbols.FlushGritScreenInstallation.FLUSH_SPEventArgs ea)
    {
      object[] _values_ = new object[3];
      if (ea.TimeFromLastFlush.HasValue) _values_[0] = ea.TimeFromLastFlush.Value;
    ...
    public bool FireEvent_FLUSH_SP(NxtControl.GuiFramework.Time TimeFromLastFlush, bool ignore_TimeFromLastFlush, NxtControl.GuiFramework.Time FlushDuration, bool ignore_FlushDuration, System.Single FlushFlowSp, bool ignore_FlushFlowSp)
    {
      object[] _values_ = new object[3];
      if (!ignore_TimeFromLastFlush) _values_[0] = TimeFromLastFlush;
    ...
    public bool FireEvent_START_FLUSH(SE.Nereda.Symbols.FlushGritScreenInstallation.START_FLUSHEventArgs ea)
    {
