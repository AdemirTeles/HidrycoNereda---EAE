...
namespace SE.Nereda.Symbols.AutoResetCdt
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			this.drawnButton1.OpenFaceplates.Add(new NxtControl.GuiFramework.OpenFaceplate("fpReset", NxtControl.GuiFramework.MouseButtonType.Click));
			this.drawnButton1.Pen = new NxtControl.Drawing.Pen("ButtonPen");
			this.drawnButton1.Radius = 4D;
			this.drawnButton1.Text = "Auto Reset";
