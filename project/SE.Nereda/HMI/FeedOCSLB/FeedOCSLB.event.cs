...
#region Definitions;
#region #FeedOCSLB_HMI;

namespace SE.Nereda.Symbols.FeedOCSLB
{
...
namespace SE.Nereda.Symbols.FeedOCSLB
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.FeedOCSLB.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.FeedOCSLB.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
