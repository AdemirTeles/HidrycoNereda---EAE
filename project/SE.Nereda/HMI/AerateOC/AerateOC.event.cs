...
namespace SE.Nereda.Symbols.AerateOC
{
...
namespace SE.Nereda.Symbols.AerateOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.AerateOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.AerateOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
