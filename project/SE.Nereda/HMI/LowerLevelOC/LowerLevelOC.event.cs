...
#region Definitions;
#region #LowerLevelOC_HMI;

namespace SE.Nereda.Symbols.LowerLevelOC
{
...
namespace SE.Nereda.Symbols.LowerLevelOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.LowerLevelOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.LowerLevelOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
