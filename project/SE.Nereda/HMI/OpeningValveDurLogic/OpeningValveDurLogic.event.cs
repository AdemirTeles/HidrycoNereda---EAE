...
namespace SE.Nereda.Symbols.OpeningValveDurLogic
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.OpeningValveDurLogic.GRAPHEventArgs> GRAPH_Fired;

    private event EventHandler<SE.Nereda.Symbols.OpeningValveDurLogic.RESET_BTNsEventArgs> RESET_BTNs_Fired;

    private event EventHandler<SE.Nereda.Symbols.OpeningValveDurLogic.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.OpeningValveDurLogic.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","GRAPH_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (RESET_BTNs_Fired != null)
          {
            try
            {
              RESET_BTNs_Fired(this, new SE.Nereda.Symbols.OpeningValveDurLogic.RESET_BTNsEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","RESET_BTNs_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.OpeningValveDurLogic.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_CNF_DUR_SP(SE.Nereda.Symbols.OpeningValveDurLogic.CNF_DUR_SPEventArgs ea)
    {
    ...
    public bool FireEvent_FORCE_CLOSE(SE.Nereda.Symbols.OpeningValveDurLogic.FORCE_CLOSEEventArgs ea)
    {
      object[] _values_ = new object[1];
...
namespace SE.Nereda.Faceplates.OpeningValveDurLogic
{
