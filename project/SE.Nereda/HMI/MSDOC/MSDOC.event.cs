...
namespace SE.Nereda.Symbols.MSDOC
{
...
namespace SE.Nereda.Symbols.MSDOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.MSDOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.MSDOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
