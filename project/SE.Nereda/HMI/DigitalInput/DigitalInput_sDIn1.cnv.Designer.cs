...
namespace SE.Nereda.Symbols.DigitalInput
{
	...
	partial class sDIn1
	{
		...
		{
			this.DigitalInput = new SE.App2CommonProcess.Symbols.DigitalInputBase.sIndicator();
			// 
			// DigitalInput
			// 
			...
			this.DigitalInput.FalseColor = new NxtControl.Drawing.Color("SE.Nereda.Passive");
			...
			this.DigitalInput.TrueColor = new NxtControl.Drawing.Color("SE.Nereda.Active");
		...
		private SE.App2CommonProcess.Symbols.DigitalInputBase.sIndicator DigitalInput;
		#endregion
	}
}
