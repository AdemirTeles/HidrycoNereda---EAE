...
namespace SE.Nereda.Symbols.EmergencyManagement
{
	...
	partial class sDataR3
	{
		...
		private void InitializeComponent()
		{
			...
			this.StartFeedPositionR3 = new System.HMI.Symbols.Base.FreeText<short>();
			...
			this.AerateTimeR3 = new System.HMI.Symbols.Base.TimeLabel();
			this.freeText6 = new NxtControl.GuiFramework.FreeText();
			this.MinutesSinceLastFeedR3 = new System.HMI.Symbols.Base.TimeLabel();
			...
			this.NextFeedHorizon = new SE.Nereda.Symbols.NextFeedHorizon.sNFHR31();
			...
			// StartFeedPositionR3
			// 
			this.StartFeedPositionR3.BeginInit();
			this.StartFeedPositionR3.DecimalPlacesCount = ((uint)(2u));
			this.StartFeedPositionR3.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 174D, 72D);
			this.StartFeedPositionR3.Font = new NxtControl.Drawing.Font("Arial", 11F, System.Drawing.FontStyle.Bold);
			this.StartFeedPositionR3.IsOnlyInput = true;
			this.StartFeedPositionR3.Name = "StartFeedPositionR3";
			propertyDictionary4.Add("Text", "${Value}");
			propertyDictionary4.Add("TextColor", new NxtControl.Drawing.Color(((byte)(0)), ((byte)(0)), ((byte)(0))));
			this.StartFeedPositionR3.Ranges.DefaultPropertyValues = propertyDictionary4;
			this.StartFeedPositionR3.TagName = "StartFeedPositionR3";
			this.StartFeedPositionR3.TextAngle = 0F;
			this.StartFeedPositionR3.EndInit();
			// 
			// freeText3
			// 
			...
			// AerateTimeR3
			// 
			this.AerateTimeR3.BeginInit();
			this.AerateTimeR3.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.AerateTimeR3.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.48D, 0D, 0D, 1D, 176D, 280D);
			this.AerateTimeR3.Font = new NxtControl.Drawing.Font("Arial", 10F, System.Drawing.FontStyle.Regular);
			this.AerateTimeR3.FontScale = false;
			this.AerateTimeR3.IsOnlyInput = true;
			this.AerateTimeR3.Name = "AerateTimeR3";
			this.AerateTimeR3.Pen = new NxtControl.Drawing.Pen("LabelPen");
			this.AerateTimeR3.TagName = "AerateTimeR3";
			this.AerateTimeR3.TextColor = new NxtControl.Drawing.Color(((byte)(0)), ((byte)(0)), ((byte)(0)));
			this.AerateTimeR3.EndInit();
			// 
			// freeText6
			// 
			...
			// 
			// MinutesSinceLastFeedR3
			// 
			this.MinutesSinceLastFeedR3.BeginInit();
			this.MinutesSinceLastFeedR3.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.MinutesSinceLastFeedR3.DesignMatrix = new NxtControl.Drawing.Matrix2D(1.44D, 0D, 0D, 1D, 32D, 128D);
			this.MinutesSinceLastFeedR3.Font = new NxtControl.Drawing.Font("Arial", 10F, System.Drawing.FontStyle.Regular);
			this.MinutesSinceLastFeedR3.FontScale = false;
			this.MinutesSinceLastFeedR3.IsOnlyInput = true;
			this.MinutesSinceLastFeedR3.Name = "MinutesSinceLastFeedR3";
			this.MinutesSinceLastFeedR3.Pen = new NxtControl.Drawing.Pen("LabelPen");
			this.MinutesSinceLastFeedR3.TagName = "MinutesSinceLastFeedR3";
			this.MinutesSinceLastFeedR3.TextColor = new NxtControl.Drawing.Color(((byte)(0)), ((byte)(0)), ((byte)(0)));
			this.MinutesSinceLastFeedR3.EndInit();
			// 
			// freeText7
			// 
		...
		private System.HMI.Symbols.Base.FreeText<short> StartFeedPositionR3;
		...
		private System.HMI.Symbols.Base.TimeLabel AerateTimeR3;
		private NxtControl.GuiFramework.FreeText freeText6;
		private System.HMI.Symbols.Base.TimeLabel MinutesSinceLastFeedR3;
		...
		private SE.Nereda.Symbols.NextFeedHorizon.sNFHR31 NextFeedHorizon;
		#endregion
	}
}
