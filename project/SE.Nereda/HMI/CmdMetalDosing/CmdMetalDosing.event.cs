...
namespace SE.Nereda.Symbols.CmdMetalDosing
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.CmdMetalDosing.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.CmdMetalDosing.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
