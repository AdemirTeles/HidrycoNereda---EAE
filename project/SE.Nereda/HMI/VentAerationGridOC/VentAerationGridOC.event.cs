...
#region Definitions;
#region #VentAerationGridOC_HMI;

namespace SE.Nereda.Symbols.VentAerationGridOC
{
...
namespace SE.Nereda.Symbols.VentAerationGridOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.VentAerationGridOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.VentAerationGridOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #VentAerationGridOC_HMI;
