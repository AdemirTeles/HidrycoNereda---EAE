...
namespace SE.Nereda.Symbols.FlushSludgeBuffer
{
	...
	partial class sSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.FlushStartSp = new System.HMI.Symbols.Base.TextBox<float>();
			...
			this.polygon1.Text = "FLUSH SLUDGE BUFFER";
			...
			// FlushStartSp
			// 
			this.FlushStartSp.BeginInit();
			this.FlushStartSp.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.64D, 0D, 0D, 1D, 240D, 32D);
			this.FlushStartSp.MaximumTag = null;
			this.FlushStartSp.MinimumTag = null;
			this.FlushStartSp.Name = "FlushStartSp";
			this.FlushStartSp.NumberBase = NxtControl.GuiFramework.NumberBase.Decimal;
			this.FlushStartSp.Pen = new NxtControl.Drawing.Pen(new NxtControl.Drawing.Color("Black"), 1F, NxtControl.Drawing.DashStyle.Solid);
			this.FlushStartSp.SetColor = new NxtControl.Drawing.Color("Yellow");
			this.FlushStartSp.TagName = "FlushStartSp";
			this.FlushStartSp.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
			this.FlushStartSp.TextColor = new NxtControl.Drawing.Color(((byte)(0)), ((byte)(0)), ((byte)(0)));
			this.FlushStartSp.UseInputPad = true;
			this.FlushStartSp.Value = 0F;
			this.FlushStartSp.EndInit();
			// 
			// freeText1
			// 
			...
			this.freeText1.Text = "Flush Start Setpoint :";
			// 
			// sSettings
			// 
		...
		private System.HMI.Symbols.Base.TextBox<float> FlushStartSp;
		#endregion
	}
}
