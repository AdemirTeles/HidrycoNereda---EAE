...
namespace SE.Nereda.Symbols.FlushSludgeBuffer
{
	...
	partial class sInfos
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(sInfos));
			this.Ctrl = new NxtControl.GuiFramework.Rectangle();
			this.FlushConditions = new SE.Nereda.Symbols.FlushCdt.sDefault();
			// 
			// Ctrl
			// 
			this.Ctrl.Bounds = new NxtControl.Drawing.RectF(((float)(40D)), ((float)(16D)), ((float)(16D)), ((float)(16D)));
			...
			this.FlushConditions.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.5D, 0D, 0D, 0.5D, 24D, 16D);
