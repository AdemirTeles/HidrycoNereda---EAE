...
#region Definitions;
#region #VentAeratorOC_HMI;

namespace SE.Nereda.Symbols.VentAeratorOC
{
...
namespace SE.Nereda.Symbols.VentAeratorOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.VentAeratorOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.VentAeratorOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
