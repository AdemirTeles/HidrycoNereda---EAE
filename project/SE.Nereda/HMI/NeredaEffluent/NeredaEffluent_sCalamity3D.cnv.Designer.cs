...
{
	/// <summary>
	/// Summary description for sCalamity3D.
	/// </summary>
	partial class sCalamity3D
	{
		...
		private void InitializeComponent()
		{
			...
			this.CALAMITY = new NxtControl.GuiFramework.Rectangle();
			...
			// CALAMITY
			// 
			this.CALAMITY.Bounds = new NxtControl.Drawing.RectF(((float)(16D)), ((float)(100D)), ((float)(280D)), ((float)(40D)));
			this.CALAMITY.Brush = new NxtControl.Drawing.Brush(new NxtControl.Drawing.Color("transparent"));
			this.CALAMITY.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Bold);
			this.CALAMITY.Name = "CALAMITY";
			this.CALAMITY.Pen = new NxtControl.Drawing.Pen(new NxtControl.Drawing.Color("transparent"), 1F, NxtControl.Drawing.DashStyle.Solid);
			this.CALAMITY.Text = "CALAMITY";
			this.CALAMITY.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
			// 
			// group1
			// 
			...
			this.sDIn11.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 16D, 88D);
			...
			this.sPvBarVer1,
			this.sDIn11});
			this.SymbolSize = new System.Drawing.Size(408, 408);
		...
		private NxtControl.GuiFramework.Rectangle CALAMITY;
