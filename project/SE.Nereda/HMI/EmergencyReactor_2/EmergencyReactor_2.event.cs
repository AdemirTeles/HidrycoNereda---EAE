...
namespace SE.Nereda.Symbols.EmergencyReactor_2
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.GRAPHEventArgs> GRAPH_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.EMERGENCY_ONEventArgs> EMERGENCY_ON_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.RESET_F_TRSEventArgs> RESET_F_TRS_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.ENABLE_FORCE_INEventArgs> ENABLE_FORCE_IN_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.S5_AERATE_TEventArgs> S5_AERATE_T_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.WARNINGEventArgs> WARNING_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;

    private event EventHandler<SE.Nereda.Symbols.EmergencyReactor_2.FORCE_UNAVEventArgs> FORCE_UNAV_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","GRAPH_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (EMERGENCY_ON_Fired != null)
          {
            try
            {
              EMERGENCY_ON_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.EMERGENCY_ONEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","EMERGENCY_ON_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (RESET_F_TRS_Fired != null)
          {
            try
            {
              RESET_F_TRS_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.RESET_F_TRSEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","RESET_F_TRS_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 3:
          if (ENABLE_FORCE_IN_Fired != null)
          {
            try
            {
              ENABLE_FORCE_IN_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.ENABLE_FORCE_INEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","ENABLE_FORCE_IN_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 4:
          if (S5_AERATE_T_Fired != null)
          {
            try
            {
              S5_AERATE_T_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.S5_AERATE_TEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","S5_AERATE_T_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 5:
          if (WARNING_Fired != null)
          {
            try
            {
              WARNING_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.WARNINGEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","WARNING_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 6:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 7:
          if (FORCE_UNAV_Fired != null)
          {
            try
            {
              FORCE_UNAV_Fired(this, new SE.Nereda.Symbols.EmergencyReactor_2.FORCE_UNAVEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","FORCE_UNAV_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_FORCE(SE.Nereda.Symbols.EmergencyReactor_2.FORCEEventArgs ea)
    {
    ...
    public bool FireEvent_ENABLE_FORCE_OUT(SE.Nereda.Symbols.EmergencyReactor_2.ENABLE_FORCE_OUTEventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_FEED_PAR(SE.Nereda.Symbols.EmergencyReactor_2.FEED_PAREventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_AERATE_PAR(SE.Nereda.Symbols.EmergencyReactor_2.AERATE_PAREventArgs ea)
    {
    ...
    public bool FireEvent_VENT_PAR(SE.Nereda.Symbols.EmergencyReactor_2.VENT_PAREventArgs ea)
    {
    ...
    public bool FireEvent_AIR_LICK_T(SE.Nereda.Symbols.EmergencyReactor_2.AIR_LICK_TEventArgs ea)
    {
      object[] _values_ = new object[1];
