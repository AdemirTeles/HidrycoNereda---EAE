...
#region Definitions;
#region #VentSludgeGridOC_HMI;

namespace SE.Nereda.Symbols.VentSludgeGridOC
{
...
namespace SE.Nereda.Symbols.VentSludgeGridOC
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.VentSludgeGridOC.OC_STATUSWORDEventArgs> OC_STATUSWORD_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (OC_STATUSWORD_Fired != null)
          {
            try
            {
              OC_STATUSWORD_Fired(this, new SE.Nereda.Symbols.VentSludgeGridOC.OC_STATUSWORDEventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #VentSludgeGridOC_HMI;
