...
{
	/// <summary>
	/// Summary description for sFlushDiagram.
	/// </summary>
	partial class sFlushDiagram
	{
		...
		private void InitializeComponent()
		{
			...
			// drawnButton1
			// 
			this.drawnButton1.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(8D)), ((float)(96D)), ((float)(25D)));
			...
			this.drawnButton1.OpenFaceplates.Add(new NxtControl.GuiFramework.OpenFaceplate("fpFlushDiagram", NxtControl.GuiFramework.MouseButtonType.Click));
