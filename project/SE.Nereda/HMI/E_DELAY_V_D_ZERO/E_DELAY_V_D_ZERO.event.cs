...
namespace SE.Nereda.Symbols.E_DELAY_V_D_ZERO
{
  partial class sDefault
  {
    ...
    private event EventHandler<SE.Nereda.Symbols.E_DELAY_V_D_ZERO.DUREventArgs> DUR_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (DUR_Fired != null)
          {
            try
            {
              DUR_Fired(this, new SE.Nereda.Symbols.E_DELAY_V_D_ZERO.DUREventArgs(channelId, cookie, eventIndex));
            }
...
#endregion #E_DELAY_V_D_ZERO_HMI;
