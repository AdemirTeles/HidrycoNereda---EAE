...
namespace SE.Nereda.Symbols.E_DELAY_V_D_ZERO
{
	/// <summary>
	...
	partial class sCounter
	{
		...
		private void InitializeComponent()
		{
			...
			this.freeText2.Location = new NxtControl.Drawing.PointF(152D, 8D);
			...
			this.Pv.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.64D, 0D, 0D, 1D, 208D, 6D);
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(144D, 23D);
			...
			this.line1.StartPoint = new NxtControl.Drawing.PointF(144D, 7D);
			// 
			// group1
			// 
