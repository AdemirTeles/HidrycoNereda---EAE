...
namespace SE.Nereda.Symbols.FlushGritScreens
{
  partial class sDefault
  {
    ...
    private SE.Nereda.Faceplates.FlushGritScreens.fpCtrl fpCtrl
    {
      get
      { 
        ...
        SE.Nereda.Faceplates.FlushGritScreens.fpCtrl faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (SE.Nereda.Faceplates.FlushGritScreens.fpCtrl)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(SE.Nereda.Faceplates.FlushGritScreens.fpCtrl));
        
        if (faceplate == null)
        {
          faceplate = new SE.Nereda.Faceplates.FlushGritScreens.fpCtrl();
