...
namespace SE.Nereda.Symbols.FlushGritScreens
{
	...
	partial class sSettings
	{
		...
		private void InitializeComponent()
		{
			...
			this.FlushCycleTime = new System.HMI.Symbols.Base.TimeTextBox();
			...
			this.polygon1.Text = "FLUSH GRIT SCREENS";
			...
			this.freeText1.Text = "Flush Cycle Time :";
			// 
			// freeText2
			// 
			...
			// FlushCycleTime
			// 
			this.FlushCycleTime.BeginInit();
			this.FlushCycleTime.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.64D, 0D, 0D, 1D, 240D, 32D);
			this.FlushCycleTime.MaximumTag = null;
			this.FlushCycleTime.MinimumTag = null;
			this.FlushCycleTime.Name = "FlushCycleTime";
			this.FlushCycleTime.TagName = "FlushCycleTime";
			this.FlushCycleTime.UseInputPad = true;
			this.FlushCycleTime.Value = new NxtControl.GuiFramework.Time(((long)(0)));
			this.FlushCycleTime.EndInit();
			// 
			// FlushDuration
			// 
		...
		private System.HMI.Symbols.Base.TimeTextBox FlushCycleTime;
