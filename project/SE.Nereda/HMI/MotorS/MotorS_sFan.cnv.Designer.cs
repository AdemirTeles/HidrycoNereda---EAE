...
namespace SE.Nereda.Symbols.MotorS
{
	...
	partial class sFan
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(sFan));
			...
			this.Base.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.26666666666666666D, 0D, 0D, 0.16666666666666666D, 52D, 52.833333333333329D);
			...
			this.State.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 28D, 76D);
			...
			// alarmFrame
			// 
			this.alarmFrame.Bounds = new NxtControl.Drawing.RectF(((float)(36D)), ((float)(30D)), ((float)(48D)), ((float)(64D)));
			...
			// OpenFp
			// 
			this.OpenFp.Bounds = new NxtControl.Drawing.RectF(((float)(36D)), ((float)(30D)), ((float)(48D)), ((float)(64D)));
			...
			// rectangle1
			// 
			this.rectangle1.Bounds = new NxtControl.Drawing.RectF(((float)(50D)), ((float)(49D)), ((float)(20D)), ((float)(20D)));
