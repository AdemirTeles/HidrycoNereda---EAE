...
namespace SE.Nereda.Symbols.MotorS
{
	...
	/// </summary>
	public partial class sFan : NxtControl.GuiFramework.HMISymbol
	{
		...
		void StateActuatorStatus(short StateValue)
		{
			...
			if(StateValue == 0 || StateValue == 254){
				MotBase1.BrushColor = MotBase2.BrushColor = SE.Nereda.ProjectColors.PassiveStatus;
			}
			if(StateValue == 1){
				MotBase1.BrushColor = MotBase2.BrushColor = SE.Nereda.ProjectColors.ActiveStatus;
			}
			if(StateValue == 253){
				MotBase1.BrushColor = MotBase2.BrushColor = new NxtControl.Drawing.BlinkColor("SE.Nereda.Orangwhite");
			}
			if(StateValue == 100){
				MotBase1.BrushColor = MotBase2.BrushColor = SE.Nereda.ProjectColors.PowerOFF;
			}
			if(StateValue == 10){
				MotBase1.BrushColor = MotBase2.BrushColor = SE.Nereda.ProjectColors.PassiveStatus;
			}
