...
namespace Hidryco.HidrycoLib.Faceplates.Motor_Inversor_Automatico_Unico
{
	...
	partial class Faceplate2
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox_11.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.48D, 0D, 0D, 1D, 176D, 90D);
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(8D, 90D);
			...
			this.freeText4.Location = new NxtControl.Drawing.PointF(8D, 158D);
			this.freeText4.Name = "freeText4";
			this.freeText4.Text = "Setpoint frequência\r\nmanual";
			// 
			// STP_FREQUENCIA_MANUAL
			// 
			this.STP_FREQUENCIA_MANUAL.BeginInit();
			this.STP_FREQUENCIA_MANUAL.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.48D, 0D, 0D, 9.9138597968777482D, 176D, 160D);
			...
			this.STP_FREQUENCIA_MANUAL.Suffix = "Hz";
			this.STP_FREQUENCIA_MANUAL.TagName = "stpFrequenciaManual";
