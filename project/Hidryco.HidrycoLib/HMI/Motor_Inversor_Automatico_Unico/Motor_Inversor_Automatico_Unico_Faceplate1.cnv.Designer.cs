...
namespace Hidryco.HidrycoLib.Faceplates.Motor_Inversor_Automatico_Unico
{
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(200D, 128D);
			...
			// btnDesligarManual
			// 
			this.btnDesligarManual.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(136D)), ((float)(80D)), ((float)(30D)));
			...
			// btnLigarManual
			// 
			this.btnLigarManual.Bounds = new NxtControl.Drawing.RectF(((float)(112D)), ((float)(136D)), ((float)(80D)), ((float)(30D)));
			...
			// btnResetFalha
			// 
			this.btnResetFalha.Bounds = new NxtControl.Drawing.RectF(((float)(60D)), ((float)(183D)), ((float)(80D)), ((float)(30D)));
			...
			this.fbkCmdManual.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 338D, 510D);
			...
			// Faceplate1
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(200D)), ((float)(220D)));
