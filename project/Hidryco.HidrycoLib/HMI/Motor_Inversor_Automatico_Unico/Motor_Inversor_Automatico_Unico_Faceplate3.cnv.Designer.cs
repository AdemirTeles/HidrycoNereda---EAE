...
{
	/// <summary>
	/// Summary description for Faceplate3.
	/// </summary>
	partial class Faceplate3
	{
		...
		private void InitializeComponent()
		{
			...
			this.stsNumeroPartidas.Ranges.DefaultPropertyValues = propertyDictionary3;
			...
			// Faceplate3
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(192D)), ((float)(186D)));
			...
			this.Size = new System.Drawing.Size(192, 186);
