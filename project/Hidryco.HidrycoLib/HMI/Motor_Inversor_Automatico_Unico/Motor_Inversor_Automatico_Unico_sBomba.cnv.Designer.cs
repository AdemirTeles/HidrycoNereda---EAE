...
namespace Hidryco.HidrycoLib.Symbols.Motor_Inversor_Automatico_Unico
{
	...
	partial class sBomba
	{
		...
		private void InitializeComponent()
		{
			...
			this.fbkStsAutomatico.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 131D, 117D);
			...
			this.falha_comunicacao1.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 82D, 50D);
			...
			this.bomba1});
			this.SymbolSize = new System.Drawing.Size(220, 200);
