...
#region Definitions;
#region #Revezamento_2_Motores_ok_HMI;

namespace Hidryco.HidrycoLib.Symbols.Revezamento_2_Motores_ok
{
...
namespace Hidryco.HidrycoLib.Symbols.Revezamento_2_Motores_ok
{
  partial class sDefault
  {
    ...
    private event EventHandler<Hidryco.HidrycoLib.Symbols.Revezamento_2_Motores_ok.E_ATUALIZA_TEMPO_RESTANTEEventArgs> E_ATUALIZA_TEMPO_RESTANTE_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (E_ATUALIZA_TEMPO_RESTANTE_Fired != null)
          {
            try
            {
              E_ATUALIZA_TEMPO_RESTANTE_Fired(this, new Hidryco.HidrycoLib.Symbols.Revezamento_2_Motores_ok.E_ATUALIZA_TEMPO_RESTANTEEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","E_ATUALIZA_TEMPO_RESTANTE_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_E_ATUALIZA_SETPOINT(System.Boolean cmdHabilitaRevezamento, System.UInt16 stpTempoEquipamento1, System.UInt16 stpTempoEquipamento2)
    {
      return ((IHMIAccessorOutput)this).FireEvent(0, new object[] {cmdHabilitaRevezamento, stpTempoEquipamento1, stpTempoEquipamento2});
    }
    public bool FireEvent_E_ATUALIZA_SETPOINT(Hidryco.HidrycoLib.Symbols.Revezamento_2_Motores_ok.E_ATUALIZA_SETPOINTEventArgs ea)
    {
    ...
    public bool FireEvent_E_ATUALIZA_SETPOINT(System.Boolean cmdHabilitaRevezamento, bool ignore_cmdHabilitaRevezamento, System.UInt16 stpTempoEquipamento1, bool ignore_stpTempoEquipamento1, System.UInt16 stpTempoEquipamento2, bool ignore_stpTempoEquipamento2)
    {
      object[] _values_ = new object[3];
...
#endregion #Revezamento_2_Motores_ok_HMI;
