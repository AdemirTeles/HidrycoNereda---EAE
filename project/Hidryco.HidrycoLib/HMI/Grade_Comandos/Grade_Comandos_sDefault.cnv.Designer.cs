...
namespace Hidryco.HidrycoLib.Symbols.Grade_Comandos
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			this.stpDiferencialNivelGrade1.TagName = "STP_DIFERENCIAL_NIVEL_GRADE1";
			...
			this.stpDiferencialNivelGrade2.TagName = "STP_DIFERENCIAL_NIVEL_GRADE2";
			...
			this.cmdLigaCicloRemoto.TagName = "CMD_LIGA_CICLO_REMOTO";
