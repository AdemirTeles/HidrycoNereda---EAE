...
namespace Hidryco.HidrycoLib.Faceplates.Rosca
{
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			this.stpVelocidade.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.53333333333333333D, 0D, 0D, 1D, 144D, 232D);
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(8D, 237D);
			this.freeText1.Name = "freeText1";
			this.freeText1.Text = "Velocidade";
			// 
			// btnManOn
			// 
			this.btnManOn.Bounds = new NxtControl.Drawing.RectF(((float)(144D)), ((float)(84D)), ((float)(80D)), ((float)(30D)));
			...
			this.freeText3.Location = new NxtControl.Drawing.PointF(48D, 128D);
			...
			// btnInterOn
			// 
			this.btnInterOn.Bounds = new NxtControl.Drawing.RectF(((float)(144D)), ((float)(134D)), ((float)(80D)), ((float)(30D)));
			...
			// btnInterOff
			// 
			this.btnInterOff.Bounds = new NxtControl.Drawing.RectF(((float)(9D)), ((float)(134D)), ((float)(80D)), ((float)(30D)));
			...
			// line2
			// 
			this.line2.EndPoint = new NxtControl.Drawing.PointF(216D, 124D);
			...
			this.line2.StartPoint = new NxtControl.Drawing.PointF(16D, 124D);
			// 
			// line3
			// 
			this.line3.EndPoint = new NxtControl.Drawing.PointF(216D, 174D);
			...
			this.line3.StartPoint = new NxtControl.Drawing.PointF(16D, 174D);
			// 
			...
			// line4
			// 
			this.line4.EndPoint = new NxtControl.Drawing.PointF(216D, 222D);
			...
			this.line4.StartPoint = new NxtControl.Drawing.PointF(16D, 222D);
			// 
			// habilitaReversao
			// 
			this.habilitaReversao.BeginInit();
			this.habilitaReversao.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 144D, 184D);
			...
			this.freeText4.Location = new NxtControl.Drawing.PointF(9D, 188D);
			...
			// Faceplate1
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(240D)), ((float)(280D)));
