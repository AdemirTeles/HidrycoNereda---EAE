...
namespace Hidryco.HidrycoLib.Symbols.Rosca
{
  partial class Esquerda
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.Rosca.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.Rosca.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.Rosca.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.Rosca.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.Rosca.Faceplate1();
