...
#region Definitions;
#region #ReservatorioElevado_HMI;

namespace Hidryco.HidrycoLib.Symbols.ReservatorioElevado
{
...
namespace Hidryco.HidrycoLib.Symbols.ReservatorioElevado
{
  partial class sDefault
  {
    ...
    public bool FireEvent_E_RESET_FALHAS_PROCESSO(Hidryco.HidrycoLib.Symbols.ReservatorioElevado.E_RESET_FALHAS_PROCESSOEventArgs ea)
    {
...
#endregion #ReservatorioElevado_HMI;
