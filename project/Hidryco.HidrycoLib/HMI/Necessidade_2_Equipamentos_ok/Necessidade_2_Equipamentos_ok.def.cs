...
namespace Hidryco.HidrycoLib.Symbols.Necessidade_2_Equipamentos_ok
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.Necessidade_2_Equipamentos_ok.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.Necessidade_2_Equipamentos_ok.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.Necessidade_2_Equipamentos_ok.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.Necessidade_2_Equipamentos_ok.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.Necessidade_2_Equipamentos_ok.Faceplate1();
