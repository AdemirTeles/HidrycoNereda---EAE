...
namespace Hidryco.HidrycoLib.Symbols.Valvula_Higienizacao
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.Valvula_Higienizacao.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.Valvula_Higienizacao.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.Valvula_Higienizacao.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.Valvula_Higienizacao.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.Valvula_Higienizacao.Faceplate1();
