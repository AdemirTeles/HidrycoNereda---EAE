...
namespace Hidryco.HidrycoLib.Symbols.PID
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.PID.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.PID.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.PID.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.PID.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.PID.Faceplate1();
