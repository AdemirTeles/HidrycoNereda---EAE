...
namespace Hidryco.HidrycoLib.Symbols.CPress
{
  partial class sDefault
  {
    ...
    private event EventHandler<Hidryco.HidrycoLib.Symbols.CPress.REQEventArgs> REQ_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (REQ_Fired != null)
          {
            try
            {
              REQ_Fired(this, new Hidryco.HidrycoLib.Symbols.CPress.REQEventArgs(channelId, cookie, eventIndex));
            }
