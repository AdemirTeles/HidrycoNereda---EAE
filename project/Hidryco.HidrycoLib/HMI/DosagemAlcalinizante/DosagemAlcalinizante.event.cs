...
#region Definitions;
#region #DosagemAlcalinizante_HMI;

namespace Hidryco.HidrycoLib.Symbols.DosagemAlcalinizante
{
...
namespace Hidryco.HidrycoLib.Symbols.DosagemAlcalinizante
{
  partial class sDefault
  {
    ...
    public bool FireEvent_E_RESET_FALHAS_PROCESSO(Hidryco.HidrycoLib.Symbols.DosagemAlcalinizante.E_RESET_FALHAS_PROCESSOEventArgs ea)
    {
...
#endregion #DosagemAlcalinizante_HMI;
