...
namespace Hidryco.HidrycoLib.Symbols.Sensor_Comunicacao
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			// line6
			// 
			this.line6.EndPoint = new NxtControl.Drawing.PointF(172.73684210526318D, 118.037037037037D);
			...
			this.line6.StartPoint = new NxtControl.Drawing.PointF(168.63157894736838D, 112.74074074074076D);
			// 
			// line4
			// 
			this.line4.EndPoint = new NxtControl.Drawing.PointF(164.52631578947367D, 123.33333333333333D);
			...
			this.line4.StartPoint = new NxtControl.Drawing.PointF(160.42105263157896D, 107.44444444444443D);
			// 
			// line3
			// 
			this.line3.EndPoint = new NxtControl.Drawing.PointF(160.42105263157896D, 107.44444444444443D);
			...
			this.line3.StartPoint = new NxtControl.Drawing.PointF(156.31578947368422D, 118.037037037037D);
			// 
			// group1
			// 
			...
			// line5
			// 
			this.line5.EndPoint = new NxtControl.Drawing.PointF(168.63157894736838D, 112.74074074074076D);
			...
			this.line5.StartPoint = new NxtControl.Drawing.PointF(164.52631578947367D, 123.33333333333333D);
			// 
			// line2
			// 
			this.line2.EndPoint = new NxtControl.Drawing.PointF(174D, 124.55555555555557D);
			...
			this.line2.StartPoint = new NxtControl.Drawing.PointF(150D, 124.55555555555557D);
			// 
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(153.78947368421052D, 127D);
			...
			this.line1.StartPoint = new NxtControl.Drawing.PointF(153.78947368421052D, 105D);
			// 
			// roundedRectangle1
			// 
			this.roundedRectangle1.Bounds = new NxtControl.Drawing.RectF(((float)(57D)), ((float)(82D)), ((float)(128D)), ((float)(50D)));
			...
			this.stsSensor.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.53333333333333333D, 0D, 0D, 0.423076923076923D, 64D, 104D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(62D)), ((float)(86D)), ((float)(58D)), ((float)(16D)));
			...
			this.alarme_icon1.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.5D, 0D, 0D, 0.5D, 157D, 87D);
			...
			this.falha_comunicacao1.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.66666666666666663D, 0D, 0D, 0.66666666666666663D, 136D, 85D);
