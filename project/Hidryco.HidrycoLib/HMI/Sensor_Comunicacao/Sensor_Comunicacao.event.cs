...
namespace Hidryco.HidrycoLib.Symbols.Sensor_Comunicacao
{
  ...
  public class REQEventArgs : System.EventArgs
  {
    ...
    public bool Get_Reliability(ref System.Single value)
    {
      if (accessorService == null)
        return false;
      float var = 0;
...
{4}","REQ_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_E_ATUALIZA_SETPOINTS(System.UInt16 STP_TEMPO_ALARME_HH, System.UInt16 STP_TEMPO_ALARME_H, System.UInt16 STP_TEMPO_ALARME_L, System.UInt16 STP_TEMPO_ALARME_LL, System.Single STP_ALARME_HH, System.Single STP_ALARME_H, System.Single STP_ALARME_L, System.Single STP_ALARME_LL, System.Boolean CMD_HABILITA_SENSOR, System.Boolean CMD_HABILITA_ALARME_HH, System.Boolean CMD_HABILITA_ALARME_H, System.Boolean CMD_HABILITA_ALARME_L, System.Boolean CMD_HABILITA_ALARME_LL)
    {
      return ((IHMIAccessorOutput)this).FireEvent(1, new object[] {STP_TEMPO_ALARME_HH, STP_TEMPO_ALARME_H, STP_TEMPO_ALARME_L, STP_TEMPO_ALARME_LL, STP_ALARME_HH, STP_ALARME_H, STP_ALARME_L, STP_ALARME_LL, CMD_HABILITA_SENSOR, CMD_HABILITA_ALARME_HH, CMD_HABILITA_ALARME_H, CMD_HABILITA_ALARME_L, CMD_HABILITA_ALARME_LL});
    }
    public bool FireEvent_E_ATUALIZA_SETPOINTS(Hidryco.HidrycoLib.Symbols.Sensor_Comunicacao.E_ATUALIZA_SETPOINTSEventArgs ea)
    {
      ...
      if (ea.CMD_HABILITA_SENSOR.HasValue) _values_[8] = ea.CMD_HABILITA_SENSOR.Value;
      if (ea.CMD_HABILITA_ALARME_HH.HasValue) _values_[9] = ea.CMD_HABILITA_ALARME_HH.Value;
      if (ea.CMD_HABILITA_ALARME_H.HasValue) _values_[10] = ea.CMD_HABILITA_ALARME_H.Value;
      if (ea.CMD_HABILITA_ALARME_L.HasValue) _values_[11] = ea.CMD_HABILITA_ALARME_L.Value;
      if (ea.CMD_HABILITA_ALARME_LL.HasValue) _values_[12] = ea.CMD_HABILITA_ALARME_LL.Value;
      return ((IHMIAccessorOutput)this).FireEvent(1, _values_);
    }
    public bool FireEvent_E_ATUALIZA_SETPOINTS(System.UInt16 STP_TEMPO_ALARME_HH, bool ignore_STP_TEMPO_ALARME_HH, System.UInt16 STP_TEMPO_ALARME_H, bool ignore_STP_TEMPO_ALARME_H, System.UInt16 STP_TEMPO_ALARME_L, bool ignore_STP_TEMPO_ALARME_L, System.UInt16 STP_TEMPO_ALARME_LL, bool ignore_STP_TEMPO_ALARME_LL, System.Single STP_ALARME_HH, bool ignore_STP_ALARME_HH, System.Single STP_ALARME_H, bool ignore_STP_ALARME_H, System.Single STP_ALARME_L, bool ignore_STP_ALARME_L, System.Single STP_ALARME_LL, bool ignore_STP_ALARME_LL, System.Boolean CMD_HABILITA_SENSOR, bool ignore_CMD_HABILITA_SENSOR, System.Boolean CMD_HABILITA_ALARME_HH, bool ignore_CMD_HABILITA_ALARME_HH, System.Boolean CMD_HABILITA_ALARME_H, bool ignore_CMD_HABILITA_ALARME_H, System.Boolean CMD_HABILITA_ALARME_L, bool ignore_CMD_HABILITA_ALARME_L, System.Boolean CMD_HABILITA_ALARME_LL, bool ignore_CMD_HABILITA_ALARME_LL)
    {
      object[] _values_ = new object[13];
      ...
      if (!ignore_CMD_HABILITA_SENSOR) _values_[8] = CMD_HABILITA_SENSOR;
      if (!ignore_CMD_HABILITA_ALARME_HH) _values_[9] = CMD_HABILITA_ALARME_HH;
      if (!ignore_CMD_HABILITA_ALARME_H) _values_[10] = CMD_HABILITA_ALARME_H;
      if (!ignore_CMD_HABILITA_ALARME_L) _values_[11] = CMD_HABILITA_ALARME_L;
      if (!ignore_CMD_HABILITA_ALARME_LL) _values_[12] = CMD_HABILITA_ALARME_LL;
      return ((IHMIAccessorOutput)this).FireEvent(1, _values_);
    }
