...
namespace Hidryco.HidrycoLib.Symbols.Equipamento_On_Off
{
	...
	partial class sValvulaVertical
	{
		...
		private void InitializeComponent()
		{
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(120D)), ((float)(88D)), ((float)(96D)), ((float)(24D)));
			...
			this.alarme_icon1.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.8571428571428571D, 0D, 0D, 0.857142857142857D, 64D, 120D);
			...
			this.falha_comunicacao1.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 32D, 120D);
			...
			// rectangle2
			// 
			this.rectangle2.Bounds = new NxtControl.Drawing.RectF(((float)(33D)), ((float)(72D)), ((float)(24D)), ((float)(40D)));
			...
			this.stsRemoto.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 33D, 73D);
			...
			this.fbkStsAutomatico.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 32D, 93D);
			...
			// line2
			// 
			this.line2.EndPoint = new NxtControl.Drawing.PointF(57D, 92D);
			...
			this.line2.StartPoint = new NxtControl.Drawing.PointF(33D, 92D);
			// 
			// Disponibilidade
			// 
