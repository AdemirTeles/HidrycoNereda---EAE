...
namespace Hidryco.HidrycoLib.Symbols.Equipamento_On_Off
{
  partial class sValvulaHorizontal
  {
    ...
    private event EventHandler<Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.REQEventArgs> REQ_Fired;

    private event EventHandler<Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_ANIMACAOEventArgs> E_ANIMACAO_Fired;

    private event EventHandler<Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_ATUALIZA_FEEDBACKEventArgs> E_ATUALIZA_FEEDBACK_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (REQ_Fired != null)
          {
            try
            {
              REQ_Fired(this, new Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.REQEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","REQ_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (E_ANIMACAO_Fired != null)
          {
            try
            {
              E_ANIMACAO_Fired(this, new Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_ANIMACAOEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","E_ANIMACAO_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (E_ATUALIZA_FEEDBACK_Fired != null)
          {
            try
            {
              E_ATUALIZA_FEEDBACK_Fired(this, new Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_ATUALIZA_FEEDBACKEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","E_ATUALIZA_FEEDBACK_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_E_COMANDO_MANUAL(Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_COMANDO_MANUALEventArgs ea)
    {
    ...
    public bool FireEvent_E_AJUSTE_SETPOINTS(Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_AJUSTE_SETPOINTSEventArgs ea)
    {
      object[] _values_ = new object[2];
    ...
    public bool FireEvent_E_RESET_FALHA(Hidryco.HidrycoLib.Symbols.Equipamento_On_Off.E_RESET_FALHAEventArgs ea)
    {
