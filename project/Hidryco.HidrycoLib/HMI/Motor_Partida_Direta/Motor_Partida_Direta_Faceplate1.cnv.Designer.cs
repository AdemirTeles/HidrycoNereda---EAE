...
namespace Hidryco.HidrycoLib.Faceplates.Motor_Partida_Direta
{
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(200D, 120D);
			...
			// btnModoManual
			// 
			this.btnModoManual.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(136D)), ((float)(80D)), ((float)(30D)));
			...
			// btnModoAutomatico
			// 
			this.btnModoAutomatico.Bounds = new NxtControl.Drawing.RectF(((float)(112D)), ((float)(136D)), ((float)(80D)), ((float)(30D)));
			...
			// btnDesligarManual
			// 
			this.btnDesligarManual.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(184D)), ((float)(80D)), ((float)(30D)));
			...
			// btnLigarManual
			// 
			this.btnLigarManual.Bounds = new NxtControl.Drawing.RectF(((float)(112D)), ((float)(184D)), ((float)(80D)), ((float)(30D)));
			...
			// btnResetFalha
			// 
			this.btnResetFalha.Bounds = new NxtControl.Drawing.RectF(((float)(60D)), ((float)(231D)), ((float)(80D)), ((float)(30D)));
			...
			this.fbkCmdManual.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.fbkCmdManual.IsOnlyInput = true;
			this.fbkCmdManual.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.fbkCmdManual.Name = "fbkCmdManual";
			this.fbkCmdManual.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// Faceplate1
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(200D)), ((float)(268D)));
