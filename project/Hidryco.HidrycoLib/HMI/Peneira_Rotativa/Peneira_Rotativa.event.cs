...
namespace Hidryco.HidrycoLib.Symbols.Peneira_Rotativa
{
  partial class sDefault
  {
    ...
    private event EventHandler<Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZAEventArgs> E_ATUALIZA_Fired;

    private event EventHandler<Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZA_FEEDBACKEventArgs> E_ATUALIZA_FEEDBACK_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (E_ATUALIZA_Fired != null)
          {
            try
            {
              E_ATUALIZA_Fired(this, new Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","E_ATUALIZA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (E_ATUALIZA_FEEDBACK_Fired != null)
          {
            try
            {
              E_ATUALIZA_FEEDBACK_Fired(this, new Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZA_FEEDBACKEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","E_ATUALIZA_FEEDBACK_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_E_ATUALIZA_COMANDO_LIGA_MANUAL(Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZA_COMANDO_LIGA_MANUALEventArgs ea)
    {
    ...
    public bool FireEvent_E_ATUALIZA_SETPOINT(Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZA_SETPOINTEventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_E_ATUALIZA_COMANDO_LIGA_INTERMITENTE(Hidryco.HidrycoLib.Symbols.Peneira_Rotativa.E_ATUALIZA_COMANDO_LIGA_INTERMITENTEEventArgs ea)
    {
      object[] _values_ = new object[1];
