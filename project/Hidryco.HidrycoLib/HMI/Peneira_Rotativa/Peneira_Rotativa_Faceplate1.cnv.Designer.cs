...
namespace Hidryco.HidrycoLib.Faceplates.Peneira_Rotativa
{
	/// <summary>
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(240D, 78D);
			...
			this.line1.StartPoint = new NxtControl.Drawing.PointF(0D, 78D);
			// 
			// freeText2
			// 
			...
			this.stpVelocidade.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.53333333333333333D, 0D, 0D, 1D, 144D, 198D);
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(8D, 203D);
			this.freeText1.Name = "freeText1";
			this.freeText1.Text = "Velocidade";
			// 
			// btnManOn
			// 
			this.btnManOn.Bounds = new NxtControl.Drawing.RectF(((float)(143D)), ((float)(90D)), ((float)(80D)), ((float)(30D)));
			...
			// btnManOff
			// 
			this.btnManOff.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(90D)), ((float)(80D)), ((float)(30D)));
			...
			// btnInterOn
			// 
			this.btnInterOn.Bounds = new NxtControl.Drawing.RectF(((float)(143D)), ((float)(144D)), ((float)(80D)), ((float)(30D)));
			...
			// btnInterOff
			// 
			this.btnInterOff.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(144D)), ((float)(80D)), ((float)(30D)));
			...
			// line2
			// 
			this.line2.EndPoint = new NxtControl.Drawing.PointF(216D, 132D);
			...
			this.line2.StartPoint = new NxtControl.Drawing.PointF(16D, 132D);
			// 
			// line3
			// 
			this.line3.EndPoint = new NxtControl.Drawing.PointF(216D, 186D);
			...
			this.line3.StartPoint = new NxtControl.Drawing.PointF(16D, 186D);
			// 
			...
			this.freeText4.Location = new NxtControl.Drawing.PointF(8D, 46D);
			this.freeText4.Name = "freeText4";
			this.freeText4.Text = "Horímetro";
			// 
			// stsHorimetroHora
			// 
