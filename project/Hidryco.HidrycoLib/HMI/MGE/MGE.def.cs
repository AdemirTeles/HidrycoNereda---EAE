...
namespace Hidryco.HidrycoLib.Symbols.MGE
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.MGE.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.MGE.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.MGE.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.MGE.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.MGE.Faceplate1();
