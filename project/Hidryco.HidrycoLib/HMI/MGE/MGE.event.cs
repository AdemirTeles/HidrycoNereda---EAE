...
namespace Hidryco.HidrycoLib.Symbols.MGE
{
  ...
  public class REQEventArgs : System.EventArgs
  {
    ...
    public bool Get_FATOR_POTENCIAL_TOTAL(ref System.Single value)
    {
      if (accessorService == null)
        return false;
      float var = 0;
    ...
    public System.Single? FATOR_POTENCIAL_TOTAL
    { get {
      if (accessorService == null)
        return null;
      float var = 0;
    ...
    public bool Get_POTENCIA_APARENTE_TOTAL(ref System.Single value)
    {
      if (accessorService == null)
        return false;
      float var = 0;
    ...
    public System.Single? POTENCIA_APARENTE_TOTAL
    { get {
      if (accessorService == null)
        return null;
      float var = 0;
