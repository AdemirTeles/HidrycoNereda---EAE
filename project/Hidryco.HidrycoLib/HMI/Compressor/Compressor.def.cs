...
namespace Hidryco.HidrycoLib.Symbols.Compressor
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.Compressor.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.Compressor.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.Compressor.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.Compressor.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.Compressor.Faceplate1();
