...
namespace Hidryco.HidrycoLib.Faceplates.Compressor
{
	/// <summary>
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			// line1
			// 
			this.line1.EndPoint = new NxtControl.Drawing.PointF(240D, 80D);
			...
			this.line1.StartPoint = new NxtControl.Drawing.PointF(0D, 80D);
			// 
			// freeText2
			// 
			...
			this.label_11.TagName = "STS_AUTOMATICO_SUBSISTEMA";
			...
			this.stpVelocidade.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.53333333333333333D, 0D, 0D, 1D, 144D, 144D);
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(8D, 149D);
			this.freeText1.Name = "freeText1";
			this.freeText1.Text = "Velocidade";
			// 
			// btnManOn
			// 
			this.btnManOn.Bounds = new NxtControl.Drawing.RectF(((float)(143D)), ((float)(92D)), ((float)(80D)), ((float)(30D)));
			...
			// btnManOff
			// 
			this.btnManOff.Bounds = new NxtControl.Drawing.RectF(((float)(8D)), ((float)(92D)), ((float)(80D)), ((float)(30D)));
			...
			this.freeText3.Location = new NxtControl.Drawing.PointF(48D, 136D);
			...
			// line3
			// 
			this.line3.EndPoint = new NxtControl.Drawing.PointF(216D, 134D);
			...
			this.line3.StartPoint = new NxtControl.Drawing.PointF(16D, 134D);
			// 
			// freeText4
			// 
			...
			// Faceplate1
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(240D)), ((float)(184D)));
