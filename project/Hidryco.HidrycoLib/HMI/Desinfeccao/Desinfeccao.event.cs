...
namespace Hidryco.HidrycoLib.Symbols.Desinfeccao
{
  partial class sDefault
  {
    ...
    public bool FireEvent_E_RESET_FALHAS_PROCESSO(Hidryco.HidrycoLib.Symbols.Desinfeccao.E_RESET_FALHAS_PROCESSOEventArgs ea)
    {
