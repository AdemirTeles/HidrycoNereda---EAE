...
namespace Hidryco.HidrycoLib.Symbols.Motor_Inversor
{
  ...
  public class E_COMANDO_MANUALEventArgs : System.EventArgs
  {
    ...
    private System.Boolean? cmdLigarManual_field = null;
    public System.Boolean? cmdLigarManual
    {
       get { return cmdLigarManual_field; }
       set { cmdLigarManual_field = value; }
    }
...
{4}","REQ_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_E_COMANDO_MANUAL(System.Boolean cmdLigarManual)
    {
      return ((IHMIAccessorOutput)this).FireEvent(3, new object[] {cmdLigarManual});
    }
    public bool FireEvent_E_COMANDO_MANUAL(Hidryco.HidrycoLib.Symbols.Motor_Inversor.E_COMANDO_MANUALEventArgs ea)
    {
      object[] _values_ = new object[1];
      if (ea.cmdLigarManual.HasValue) _values_[0] = ea.cmdLigarManual.Value;
      return ((IHMIAccessorOutput)this).FireEvent(3, _values_);
    }
    public bool FireEvent_E_COMANDO_MANUAL(System.Boolean cmdLigarManual, bool ignore_cmdLigarManual)
    {
      object[] _values_ = new object[1];
      if (!ignore_cmdLigarManual) _values_[0] = cmdLigarManual;
      return ((IHMIAccessorOutput)this).FireEvent(3, _values_);
    }
    ...
    {
      return ((IHMIAccessorOutput)this).FireEvent(5, new object[] {stpTempoFalhaLigamento, stpTempoFalhaDesligamento, stpSaidaManual});
    }
