...
namespace Hidryco.HidrycoLib.Faceplates.Motor_Inversor
{
	...
	partial class Faceplate4
	{
		...
		private void InitializeComponent()
		{
			...
			this.STS_CORRENTE.DecimalPlacesCount = ((uint)(2u));
			...
			this.STS_FREQUENCIA.DecimalPlacesCount = ((uint)(2u));
			...
			this.STS_TENSAO.DecimalPlacesCount = ((uint)(2u));
			...
			this.STS_TORQUE.DecimalPlacesCount = ((uint)(2u));
			...
			this.STS_POTENCIA.DecimalPlacesCount = ((uint)(2u));
