...
namespace Hidryco.HidrycoLib.Faceplates.Motor_Inversor
{
	...
	partial class Faceplate1
	{
		...
		private void InitializeComponent()
		{
			...
			this.fbkCmdManual.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 169D, 255D);
			this.fbkCmdManual.IsOnlyInput = true;
			this.fbkCmdManual.Location = new NxtControl.Drawing.PointF(169D, 255D);
