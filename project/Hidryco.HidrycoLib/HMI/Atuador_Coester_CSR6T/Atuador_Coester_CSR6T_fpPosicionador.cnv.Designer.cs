...
namespace Hidryco.HidrycoLib.Faceplates.Atuador_Coester_CSR6T
{
	...
	partial class fpPosicionador
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnPosicionar = new NxtControl.GuiFramework.DrawnButton();
			...
			this.stpPosicaoDesejada = new System.HMI.Symbols.Base.TextBox<short>();
			this.btnParar = new NxtControl.GuiFramework.DrawnButton();
			// 
			// line1
			// 
			...
			// line2
			// 
			this.line2.EndPoint = new NxtControl.Drawing.PointF(200D, 265D);
			...
			this.line2.StartPoint = new NxtControl.Drawing.PointF(8D, 265D);
			// 
			// btnPosicionar
			// 
			this.btnPosicionar.Bounds = new NxtControl.Drawing.RectF(((float)(115D)), ((float)(279D)), ((float)(80D)), ((float)(30D)));
			this.btnPosicionar.Brush = new NxtControl.Drawing.Brush("ButtonBrush");
			this.btnPosicionar.Font = new NxtControl.Drawing.Font("ButtonFont");
			this.btnPosicionar.InnerBorderColor = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonInnerBorderColor");
			this.btnPosicionar.Name = "btnPosicionar";
			this.btnPosicionar.Pen = new NxtControl.Drawing.Pen("ButtonPen");
			this.btnPosicionar.Radius = 4D;
			this.btnPosicionar.Text = "Posicionar";
			this.btnPosicionar.TextColor = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonTextColor");
			this.btnPosicionar.TextColorMouseDown = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonTextColorMouseDown");
			this.btnPosicionar.Use3DEffect = false;
			this.btnPosicionar.MouseDown += new System.Windows.Forms.MouseEventHandler(this.BtnPosicionarMouseDown);
			this.btnPosicionar.MouseUp += new System.Windows.Forms.MouseEventHandler(this.BtnPosicionarMouseUp);
			// 
			// freeText3
			// 
			...
			this.stsPosicaoAtual.TagName = "STS_POSICAO_ATUAL";
			this.stsPosicaoAtual.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleRight;
			this.stsPosicaoAtual.EndInit();
			// 
			// stpPosicaoDesejada
			// 
			this.stpPosicaoDesejada.BeginInit();
			this.stpPosicaoDesejada.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.53333333333333333D, 0D, 0D, 1D, 11D, 281D);
			this.stpPosicaoDesejada.IsPrefixSuffixOutside = false;
			this.stpPosicaoDesejada.MaximumTag = null;
			this.stpPosicaoDesejada.MinimumTag = null;
			this.stpPosicaoDesejada.Name = "stpPosicaoDesejada";
			this.stpPosicaoDesejada.NumberBase = NxtControl.GuiFramework.NumberBase.Decimal;
			this.stpPosicaoDesejada.Pen = new NxtControl.Drawing.Pen("TextBoxPen");
			this.stpPosicaoDesejada.SetColor = new NxtControl.Drawing.Color("Yellow");
			this.stpPosicaoDesejada.Suffix = "%";
			this.stpPosicaoDesejada.TagName = "STP_POSICAO_DESEJADA_MANUAL";
			this.stpPosicaoDesejada.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleRight;
			this.stpPosicaoDesejada.UseInputPad = true;
			this.stpPosicaoDesejada.UseRange = true;
			this.stpPosicaoDesejada.Value = ((short)(0));
			this.stpPosicaoDesejada.EndInit();
			// 
			// btnParar
			// 
			this.btnParar.Bounds = new NxtControl.Drawing.RectF(((float)(64D)), ((float)(223D)), ((float)(80D)), ((float)(30D)));
			this.btnParar.Brush = new NxtControl.Drawing.Brush("ButtonBrush");
			this.btnParar.Font = new NxtControl.Drawing.Font("ButtonFont");
			this.btnParar.InnerBorderColor = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonInnerBorderColor");
			this.btnParar.Name = "btnParar";
			this.btnParar.Pen = new NxtControl.Drawing.Pen("ButtonPen");
			this.btnParar.Radius = 4D;
			this.btnParar.Text = "Parar";
			this.btnParar.TextColor = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonTextColor");
			this.btnParar.TextColorMouseDown = new NxtControl.Drawing.Color("Hidryco.HidrycoLib.ButtonTextColorMouseDown");
			this.btnParar.Use3DEffect = false;
			this.btnParar.MouseDown += new System.Windows.Forms.MouseEventHandler(this.BtnPararMouseDown);
			this.btnParar.MouseUp += new System.Windows.Forms.MouseEventHandler(this.BtnPararMouseUp);
			// 
			// fpPosicionador
			// 
			this.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(0D)), ((float)(208D)), ((float)(322D)));
			...
			this.line2,
			this.btnPosicionar,
			this.stpPosicaoDesejada,
			this.freeText3,
			this.stsRemoto,
			this.fbkStsAutomatico,
			this.stsPosicaoAtual,
			this.btnParar});
			this.Size = new System.Drawing.Size(208, 322);
		...
		private NxtControl.GuiFramework.DrawnButton btnPosicionar;
		private System.HMI.Symbols.Base.TextBox<short> stpPosicaoDesejada;
		...
		private NxtControl.GuiFramework.DrawnButton btnParar;
		#endregion
	}
}
