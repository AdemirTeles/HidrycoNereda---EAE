...
{
	public partial class fpPosicionador : NxtControl.GuiFramework.HMIFaceplate
	{
		...
		void BtnPararMouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			FireEvent_E_CMD_PARAR_MANUAL(true);
		}

		void BtnPararMouseUp(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			FireEvent_E_CMD_PARAR_MANUAL(false);
		}
	}
}
