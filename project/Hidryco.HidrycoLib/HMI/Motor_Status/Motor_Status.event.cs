...
namespace Hidryco.HidrycoLib.Symbols.Motor_Status
{
  partial class Motor
  {
    ...
    private event EventHandler<Hidryco.HidrycoLib.Symbols.Motor_Status.E_ATUALIZAEventArgs> E_ATUALIZA_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (E_ATUALIZA_Fired != null)
          {
            try
            {
              E_ATUALIZA_Fired(this, new Hidryco.HidrycoLib.Symbols.Motor_Status.E_ATUALIZAEventArgs(channelId, cookie, eventIndex));
            }
