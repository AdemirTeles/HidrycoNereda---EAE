...
{
	/// <summary>
	/// Summary description for Automatico.
	/// </summary>
	partial class Automatico
	{
		...
		private void InitializeComponent()
		{
			...
			this.freeText1.Location = new NxtControl.Drawing.PointF(68D, 22D);
			this.freeText1.Name = "freeText1";
			this.freeText1.Text = "A";
			// 
			// Automatico
			// 
			...
			this.rectangle1,
			this.freeText1});
			this.SymbolSize = new System.Drawing.Size(176, 136);
