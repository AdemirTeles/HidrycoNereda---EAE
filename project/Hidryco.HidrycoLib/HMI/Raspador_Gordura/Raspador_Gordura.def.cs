...
namespace Hidryco.HidrycoLib.Symbols.Raspador_Gordura
{
  partial class sDefault
  {
    ...
    private Hidryco.HidrycoLib.Faceplates.Raspador_Gordura.Faceplate1 Faceplate1
    {
      get
      { 
        ...
        Hidryco.HidrycoLib.Faceplates.Raspador_Gordura.Faceplate1 faceplate = null;
        ...
        if (hmiManagementService != null)
          faceplate = (Hidryco.HidrycoLib.Faceplates.Raspador_Gordura.Faceplate1)hmiManagementService.GetRegisteredHMIFaceplate(MapPath, typeof(Hidryco.HidrycoLib.Faceplates.Raspador_Gordura.Faceplate1));
        
        if (faceplate == null)
        {
          faceplate = new Hidryco.HidrycoLib.Faceplates.Raspador_Gordura.Faceplate1();
