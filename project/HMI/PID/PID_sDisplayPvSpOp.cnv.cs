...
namespace HMI.Main.Symbols.PID
{
	...
	public partial class sDisplayPvSpOp : SE.App2Base.Symbols.SEAppLibHMISymbol,SE.App2CommonProcess.SupportClasses.IPropertiesNotifyChange
	{
		...
		public sDisplayPvSpOp()
		{
			...
			sDisplayPvSpOp1.Instancelayer = InstanceLayer.Top;
		...
		void SDisplayPvSpOpSecurityOwnerChanged(bool isSecurity)
		{
			sDisplayPvSpOp1.SecOwner = SecOwner;
		}

		void SDisplayPvSpOpSecurityParameterChanged(bool isSecurity)
		{
			sDisplayPvSpOp1.SecParameter = SecParameter;
		}

		void SDisplayPvSpOpSecuritySetpointChanged(bool isSecurity)
		{
			sDisplayPvSpOp1.SecSetpoint = SecSetpoint;
		}
		...
		{
			get { return sDisplayPvSpOp1.DisplayType;}
			set { sDisplayPvSpOp1.DisplayType = value; }
		}

		public void UpdateIProperties()
		{
			sDisplayPvSpOp1.Unit.PvSpValue = Unit.PvSpValue;
			sDisplayPvSpOp1.Unit.OutValue = Unit.OutValue;
			sDisplayPvSpOp1.DecimalPlacesCount.PvSpValue =  DecimalPlacesCount.PvSpValue;
			sDisplayPvSpOp1.DecimalPlacesCount.OutValue =  DecimalPlacesCount.OutValue;
		}
