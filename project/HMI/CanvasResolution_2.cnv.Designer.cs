...
{
  /// <summary>
  /// Summary description for CanvasResolution_2.
  /// </summary>
  partial class CanvasResolution_2
  {
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CanvasResolution_2));         
...
this.aliasName1 = new NxtControl.GuiFramework.AliasNameToggleButton();
...
this.logState1 = new NxtControl.GuiFramework.LogState();
      ...
      this.canvasTopologySeparator2.Bounds = new NxtControl.Drawing.RectF(((float)(1121)), ((float)(0)), ((float)(2)), ((float)(70)));
      ...
      this.exit1.Bounds = new NxtControl.Drawing.RectF(((float)(1331)), ((float)(0)), ((float)(35)), ((float)(35)));
      this.exit1.Text = "";
      this.exit1.Radius = 0;
      this.exit1.LookAndFeel = "Theme";
      this.exit1.Pen = NxtControl.Drawing.Pen.FromName("Transparent");
      this.exit1.Name = "exit1";
      this.exit1.Warning = false;
      this.exit1.WarningText = "";
			// 
      // login1
      // 
      this.login1.Anchor = NxtControl.Drawing.AnchorStyles.Right;
      this.login1.Bounds = new NxtControl.Drawing.RectF(((float)(1261)), ((float)(0)), ((float)(35)), ((float)(35)));
      this.login1.Text = "";
      ...
      this.language1.Bounds = new NxtControl.Drawing.RectF(((float)(1296)), ((float)(0)), ((float)(35)), ((float)(35)));
      ...
      // aliasName1
      // 
      this.aliasName1.Anchor = NxtControl.Drawing.AnchorStyles.Right;
      this.aliasName1.Bounds = new NxtControl.Drawing.RectF(((float)(1226)), ((float)(0)), ((float)(35)), ((float)(35)));
      this.aliasName1.Text = "";
      this.aliasName1.Radius = 0;
      this.aliasName1.LookAndFeel = "Theme";
      this.aliasName1.Pen = NxtControl.Drawing.Pen.FromName("Transparent");
      this.aliasName1.Name = "aliasName1";
			// 
      // runtimeConnection1
      // 
      this.runtimeConnection1.Anchor = NxtControl.Drawing.AnchorStyles.Right;
      this.runtimeConnection1.Bounds = new NxtControl.Drawing.RectF(((float)(1191)), ((float)(0)), ((float)(35)), ((float)(35)));
      ...
      this.newVersionDeployment1.Bounds = new NxtControl.Drawing.RectF(((float)(1156)), ((float)(0)), ((float)(35)), ((float)(35)));
    ...
    // 
      ...
      this.canvasTopologyNavigation.Bounds = new NxtControl.Drawing.RectF(((float)(104)), ((float)(0)), ((float)(668)), ((float)(35)));
      ...
      // logger
      //      
      this.logState1.Bounds = new NxtControl.Drawing.RectF(((float)(1121)), ((float)(0)), ((float)(35)), ((float)(35)));
...
private NxtControl.GuiFramework.AliasNameToggleButton aliasName1;
