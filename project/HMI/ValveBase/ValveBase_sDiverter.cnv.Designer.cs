...
namespace HMI.Main.Symbols.ValveBase
{
	...
	partial class sDiverter
	{
		...
		private void InitializeComponent()
		{
			...
			this.SValve1 = new SE.App2CommonProcess.Graphics.SDiverter();
			...
			this.interlock.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 50D, 68D);
			...
			this.owner.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 105D, 51D);
			...
			this.abnormal.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 87D, 79D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(98D)), ((float)(19D)), ((float)(58D)), ((float)(20D)));
			...
			this.SValve1.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 69D, 52D);
			this.SValve1.Direction = false;
			this.SValve1.EnAct2 = true;
			this.SValve1.MotorisedHead = false;
			...
			this.SValve1,
			this.abnormal});
			this.SymbolSize = new System.Drawing.Size(139, 127);
		...
		private SE.App2CommonProcess.Graphics.SDiverter SValve1;
		//private NxtControl.GuiFramework.AlarmFrame alarmFrame1;
		#endregion
	}
}
