...
namespace HMI.Main.Symbols.ValveBase
{
	...
	partial class sDamper
	{
		...
		private void InitializeComponent()
		{
			...
			this.SValve = new SE.App2CommonProcess.Graphics.SDamper();
			...
			// alarmFrame1
			// 
			this.alarmFrame1.Bounds = new NxtControl.Drawing.RectF(((float)(78D)), ((float)(40D)), ((float)(45D)), ((float)(84D)));
			...
			this.interlock.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 82D, 106D);
			...
			this.permissive.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 99D, 106D);
			...
			this.owner.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 106D, 46D);
			...
			this.abnormal.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 101D, 61D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(64D)), ((float)(20D)), ((float)(74D)), ((float)(20D)));
			...
			this.SValve.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 65D, 47D);
			this.SValve.Direction = false;
			this.SValve.EnAct2 = true;
			this.SValve.Externalcontrolled = false;
			this.SValve.MotorisedHead = false;
			...
			this.SValve.OpValue = SE.App2CommonProcess.SupportClasses.SpOpFbState.Passive;
			this.SValve.TransFbValue = ((short)(0));
			this.SValve.EndInit();
			// 
			// ExternalControlled
			// 
			...
			this.SymbolSize = new System.Drawing.Size(215, 202);
		...
		private SE.App2CommonProcess.Graphics.SDamper SValve;
