...
namespace HMI.Main.Symbols.ValveBase
{
	...
	public partial class sLflHorz : SE.App2Base.Symbols.SEAppLibHMISymbol, IPropertiesNotifyChange
	{
		...
		void setLocation()
		{
			...
			permissive.Location = new NxtControl.Drawing.PointF(sValve.Location.X + sValve.Size.Width + 10 , sValve.Location.Y-5);
			interlock.Location = new NxtControl.Drawing.PointF( sValve.Location.X + sValve.Size.Width+10,permissive.Location.Y + 20);
