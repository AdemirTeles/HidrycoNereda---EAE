...
namespace HMI.Main.Symbols.EmergencySludgeBuffer
{
...
namespace HMI.Main.Symbols.EmergencySludgeBuffer
{
  partial class Symbol1
  {
    ...
    private event EventHandler<HMI.Main.Symbols.EmergencySludgeBuffer.LOAD_PERS_DATAEventArgs> LOAD_PERS_DATA_Fired;

    private event EventHandler<HMI.Main.Symbols.EmergencySludgeBuffer.GRAPHEventArgs> GRAPH_Fired;

    private event EventHandler<HMI.Main.Symbols.EmergencySludgeBuffer.EMERGENCY_ONEventArgs> EMERGENCY_ON_Fired;

    private event EventHandler<HMI.Main.Symbols.EmergencySludgeBuffer.FORCE_UNAVEventArgs> FORCE_UNAV_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (LOAD_PERS_DATA_Fired != null)
          {
            try
            {
              LOAD_PERS_DATA_Fired(this, new HMI.Main.Symbols.EmergencySludgeBuffer.LOAD_PERS_DATAEventArgs(channelId, cookie, eventIndex));
            }
...
{4}","LOAD_PERS_DATA_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 1:
          if (GRAPH_Fired != null)
          {
            try
            {
              GRAPH_Fired(this, new HMI.Main.Symbols.EmergencySludgeBuffer.GRAPHEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","GRAPH_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 2:
          if (EMERGENCY_ON_Fired != null)
          {
            try
            {
              EMERGENCY_ON_Fired(this, new HMI.Main.Symbols.EmergencySludgeBuffer.EMERGENCY_ONEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","EMERGENCY_ON_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
        ...
        case 3:
          if (FORCE_UNAV_Fired != null)
          {
            try
            {
              FORCE_UNAV_Fired(this, new HMI.Main.Symbols.EmergencySludgeBuffer.FORCE_UNAVEventArgs(channelId, cookie, eventIndex));
            }
            catch (System.Exception e)
            {
              NxtControl.Services.LoggingService.ErrorFormatted(@"In Event Callback for event:'{0}' Type:'{1}' CAT:'{2}' came exception:{3}
...
{4}","FORCE_UNAV_Fired", this.GetType().Name, this.CATName, e.Message, e.StackTrace);
    ...
    public bool FireEvent_FORCE(HMI.Main.Symbols.EmergencySludgeBuffer.FORCEEventArgs ea)
    {
    ...
    public bool FireEvent_STEPS_TIME(HMI.Main.Symbols.EmergencySludgeBuffer.STEPS_TIMEEventArgs ea)
    {
    ...
    public bool FireEvent_SLD_DIS_PAR(HMI.Main.Symbols.EmergencySludgeBuffer.SLD_DIS_PAREventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_SUP_DIS_PAR(HMI.Main.Symbols.EmergencySludgeBuffer.SUP_DIS_PAREventArgs ea)
    {
      object[] _values_ = new object[1];
    ...
    public bool FireEvent_REST_LVL(HMI.Main.Symbols.EmergencySludgeBuffer.REST_LVLEventArgs ea)
    {
      object[] _values_ = new object[1];
