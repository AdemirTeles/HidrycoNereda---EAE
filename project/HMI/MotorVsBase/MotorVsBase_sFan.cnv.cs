...
namespace HMI.Main.Symbols.MotorVsBase
{
	...
	/// </summary>
	public partial class sFan : SE.App2Base.Symbols.SEAppLibHMISymbol, IPropertiesNotifyChange
	{
		...
		public sFan()
		{
			...
			fanAppearance = new FanAppearance(this);
		...
		bool AbnormalVal;
		bool ActionReqVal;
		public bool isOverAbnormalEnabled = true;
		...
		{
			AbnormalVal = sim || (overr && isOverAbnormalEnabled) || maint || oos || ilckAbnormal || permAbnormal || failAbnormal || OwnerAbnormal;
		...
		protected override void OnInitializeFaceplate(HMIFaceplate hmiFaceplate)
		{
			...
			if (fp != null) {
				...
				fp.isOverrideEnabled = isOverAbnormalEnabled;
			}
		...
		public FanAppearance FanAppearance
		{
			get { return fanAppearance; }
			set { fanAppearance = value;}
		}
		...
		public void UpdateIProperties()
		{
			//Setting the View
			initProperties = true;
			symbol.FanAppearance.Rotation = FanAppearance.Rotation;
			symbol.FanAppearance.HOrientation = FanAppearance.HOrientation;
			symbol.FanAppearance.VOrientation = FanAppearance.VOrientation;
			symbol.FanAppearance.FanSizeType = FanAppearance.FanSizeType;
			symbol.FanAppearance.BaseSymVisibility = FanAppearance.BaseSymVisibility;
			symbol.FanAppearance.WingsSymVisibility = FanAppearance.WingsSymVisibility;
			SetView();
		}
		...
		void SetView()
		{
			...
			if(fanAppearance.FanSizeType == FanSize.Small)
			{
				if (fanAppearance.Rotation == ServoRotation.Horizontal) {
						SMeters.Location = new NxtControl.Drawing.PointF(17, 93);
						interlock.Location = new NxtControl.Drawing.PointF(44, 23);
						permissive.Location = new NxtControl.Drawing.PointF(61, 24);
						failure.Location = new NxtControl.Drawing.PointF(78, 24);
						symbol.Location = new NxtControl.Drawing.PointF(56, 43);
						state.Location = new NxtControl.Drawing.PointF(54, 74);
						owner.Location = new NxtControl.Drawing.PointF(70,74);
						abnormal.Location = new NxtControl.Drawing.PointF(74,55);
						
						InstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
						InstanceName.X = (symbol.Location.X + (symbol.Size.Width / 2)) - (InstanceName.Size.Width / 2);
					
				}
				
				if (fanAppearance.Rotation == ServoRotation.Vertical) {
							
						interlock.Location = new NxtControl.Drawing.PointF(42, 20);
						permissive.Location = new NxtControl.Drawing.PointF(42, 37);
						failure.Location = new NxtControl.Drawing.PointF(42, 54);
						state.Location = new NxtControl.Drawing.PointF(97, 45);
						owner.Location = new NxtControl.Drawing.PointF(97, 27);
						abnormal.Location = new NxtControl.Drawing.PointF(79, 42);
						SMeters.Location = new NxtControl.Drawing.PointF(120, 25);
						symbol.Location = new NxtControl.Drawing.PointF(61, 30);
						InstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
			...
			if(fanAppearance.FanSizeType == FanSize.Large)
			{
				if (fanAppearance.Rotation == ServoRotation.Horizontal) {
						SMeters.Location = new NxtControl.Drawing.PointF(17, 108);
						interlock.Location = new NxtControl.Drawing.PointF(44, 23);
						permissive.Location = new NxtControl.Drawing.PointF(61, 24);
						failure.Location = new NxtControl.Drawing.PointF(78, 24);
						symbol.Location = new NxtControl.Drawing.PointF(49, 43);
						state.Location = new NxtControl.Drawing.PointF(54, 88);
						owner.Location = new NxtControl.Drawing.PointF(70,88);
						abnormal.Location = new NxtControl.Drawing.PointF(75,72);
				...
				if (fanAppearance.Rotation == ServoRotation.Vertical) {
						...
						permissive.Location = new NxtControl.Drawing.PointF(42, 37);
						failure.Location = new NxtControl.Drawing.PointF(42, 54);
						state.Location = new NxtControl.Drawing.PointF(102, 45);
						owner.Location = new NxtControl.Drawing.PointF(102, 27);
						abnormal.Location = new NxtControl.Drawing.PointF(87, 54);
						SMeters.Location = new NxtControl.Drawing.PointF(125, 25);
						symbol.Location = new NxtControl.Drawing.PointF(61, 25);
						InstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
						InstanceName.X = (SMeters.Location.X + (SMeters.Size.Width / 2)) - (InstanceName.Size.Width / 2);
