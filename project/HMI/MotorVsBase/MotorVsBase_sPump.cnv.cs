...
{
	/// <summary>
	/// Description of sPump.
	/// </summary>
	public partial class sPump : SE.App2Base.Symbols.SEAppLibHMISymbol
	{
		public sPump()
		{
			//
		...
		MotorOrientation iServoOrientation = MotorOrientation.Left;
		[RefreshProperties(RefreshProperties.All)]
		[Category("Configuration")]
		[DisplayName("Orientation")]
		[LRDescriptionAttribute("$key:SE.App2CommonProcess.Orientation")]
		[DefaultValue(MotorOrientation.Left)]
		[Browsable(true)]
		public MotorOrientation ServoOrientation {
			get { return this.iServoOrientation; }
			set {
				this.iServoOrientation = value;
		...
		void DirectionView()
		{
			MotBase.BrushColor = Base.BrushColor = Inlet.BrushColor = Outlet.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyPassive");
			Reverse.Visible = false;
			Forward.Visible = false;
			...
			switch (fbStatus) {
				case (short)SpOpFbState.Active1:
					...
					Reverse.Visible = false;
					MotBase.BrushColor = Base.BrushColor = Inlet.BrushColor = Outlet.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyActive");
					break;
		...
		void SPumpUpdateOptionalService(string instancePath)
		{
		...
		void SetView()
		{
			...
			switch (ServoOrientation) {
					
				case MotorOrientation.Left:
					Inlet.Location = new NxtControl.Drawing.PointF(53, 58);
					Outlet.Location = new NxtControl.Drawing.PointF(68, 46);
					Outlet.Size = new NxtControl.Drawing.SizeF(13, 6);
					interlock.Location = new NxtControl.Drawing.PointF(44, 21);
					permissive.Location = new NxtControl.Drawing.PointF(61, 21);
					failure.Location = new NxtControl.Drawing.PointF(78, 21);
				...
				case MotorOrientation.Right:
					Inlet.Location = new NxtControl.Drawing.PointF(68, 58);
					Outlet.Location = new NxtControl.Drawing.PointF(54, 46);
					Outlet.Size = new NxtControl.Drawing.SizeF(13, 6);
					interlock.Location = new NxtControl.Drawing.PointF(44, 21);
					permissive.Location = new NxtControl.Drawing.PointF(61, 21);
					failure.Location = new NxtControl.Drawing.PointF(78, 21);
				...
				case MotorOrientation.LeftUp:
					Inlet.Location = new NxtControl.Drawing.PointF(68, 58);
					Outlet.Location = new NxtControl.Drawing.PointF(57.5, 42);
					Outlet.Size = new NxtControl.Drawing.SizeF(6, 13);
					interlock.Location = new NxtControl.Drawing.PointF(36, 37);
					permissive.Location = new NxtControl.Drawing.PointF(36, 54);
					failure.Location = new NxtControl.Drawing.PointF(36, 71);
					InstanceName.X = ((MotBase.Location.X + (MotBase.Size.Width / 2)) - (InstanceName.Size.Width / 2) + 35);
					InstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
					break;
					
				case MotorOrientation.RightUp:
					Inlet.Location = new NxtControl.Drawing.PointF(53, 58);
					Outlet.Location = new NxtControl.Drawing.PointF(70, 42);
					Outlet.Size = new NxtControl.Drawing.SizeF(6, 13);
					interlock.Location = new NxtControl.Drawing.PointF(88, 37);
					permissive.Location = new NxtControl.Drawing.PointF(88, 54);
					failure.Location = new NxtControl.Drawing.PointF(88, 71);
					InstanceName.X = ((MotBase.Location.X + (MotBase.Size.Width / 2)) - (InstanceName.Size.Width / 2) + 45);
					InstanceName.TextAlignment = NxtControl.Drawing.ContentAlignment.MiddleCenter;
					break;
			}
		...
		{
			if (fbfail || devfail) {
				MotBase.BrushColor = Base.BrushColor = Inlet.BrushColor = Outlet.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyAlarm");
			}
		}
