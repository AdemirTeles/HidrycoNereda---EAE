...
namespace HMI.Main.Symbols.MotorVsBase
{
	...
	/// </summary>
	public partial class sConveyor : SE.App2Base.Symbols.SEAppLibHMISymbol
	{
		...
		void DirectionView()
		{
			MotBase.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyPassive");
			
			switch (fbStatus) {
				case (short)SpOpFbState.Active1:
					MotBase.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyActive");
					break;
		...
		{
			if (fbfail || devfail) {
				MotBase.BrushColor = NxtControl.Drawing.Color.FromName("SE.App2Base.aaLibSymBodyAlarm");
			}
		}
