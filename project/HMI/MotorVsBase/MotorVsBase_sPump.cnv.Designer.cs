...
namespace HMI.Main.Symbols.MotorVsBase
{
	...
	partial class sPump
	{
		...
		private void InitializeComponent()
		{
			...
			this.arcFwd = new NxtControl.GuiFramework.Arc();
			...
			// Base
			// 
			this.Base.Bounds = new NxtControl.Drawing.RectF(((float)(56D)), ((float)(65D)), ((float)(22D)), ((float)(4D)));
			...
			new NxtControl.Drawing.PointF(56D, 69D),
			new NxtControl.Drawing.PointF(78D, 69D),
			new NxtControl.Drawing.PointF(71D, 65D),
			new NxtControl.Drawing.PointF(63D, 65D)});
			// 
			// Reverse
			// 
			...
			// ArcRev
			// 
			this.ArcRev.Bounds = new NxtControl.Drawing.RectF(((float)(60D)), ((float)(49D)), ((float)(14D)), ((float)(14D)));
			this.ArcRev.Center = new NxtControl.Drawing.PointF(67D, 56D);
			...
			// Arrowrev
			// 
			this.Arrowrev.Bounds = new NxtControl.Drawing.RectF(((float)(62.7D)), ((float)(61.5D)), ((float)(2D)), ((float)(2D)));
			...
			new NxtControl.Drawing.PointF(62.7D, 63.5D),
			new NxtControl.Drawing.PointF(64.7D, 61.5D),
			new NxtControl.Drawing.PointF(64.7D, 63.5D)});
			// 
			// arcFwd
			// 
			this.arcFwd.Bounds = new NxtControl.Drawing.RectF(((float)(60D)), ((float)(49D)), ((float)(14D)), ((float)(14D)));
			this.arcFwd.Center = new NxtControl.Drawing.PointF(67D, 56D);
			this.arcFwd.Name = "arcFwd";
			this.arcFwd.Pen = new NxtControl.Drawing.Pen(new NxtControl.Drawing.Color("SymStaticIconColor"), 1F, NxtControl.Drawing.DashStyle.Solid);
			this.arcFwd.RadiusX = 7D;
			this.arcFwd.RadiusY = 7D;
			this.arcFwd.StartAngle = 170D;
			this.arcFwd.SweepAngle = 250D;
			// 
			// ArrowFwd
			// 
			this.ArrowFwd.Bounds = new NxtControl.Drawing.RectF(((float)(70D)), ((float)(61D)), ((float)(2D)), ((float)(2D)));
			this.ArrowFwd.Brush = new NxtControl.Drawing.Brush(new NxtControl.Drawing.Color(((byte)(0)), ((byte)(0)), ((byte)(0))));
			...
			new NxtControl.Drawing.PointF(72D, 63D),
			new NxtControl.Drawing.PointF(70D, 61D),
			new NxtControl.Drawing.PointF(70D, 63D)});
			this.ArrowFwd.TextColor = new NxtControl.Drawing.Color("SymStaticIconColor");
			// 
			// Forward
			// 
			...
			// MotBase
			// 
			this.MotBase.Bounds = new NxtControl.Drawing.RectF(((float)(56D)), ((float)(45D)), ((float)(22D)), ((float)(22D)));
			...
			// Inlet
			// 
			this.Inlet.Bounds = new NxtControl.Drawing.RectF(((float)(54D)), ((float)(59D)), ((float)(13D)), ((float)(6D)));
			this.Inlet.Brush = new NxtControl.Drawing.Brush(new NxtControl.Drawing.Color("SE.App2Base.aaLibSymBodyActive"));
			this.Inlet.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Regular);
			this.Inlet.Name = "Inlet";
			this.Inlet.Pen = new NxtControl.Drawing.Pen(new NxtControl.Drawing.Color("SymStaticIconColor"), 1F, NxtControl.Drawing.DashStyle.Solid);
			// 
			// Outlet
			// 
			this.Outlet.Bounds = new NxtControl.Drawing.RectF(((float)(68D)), ((float)(45D)), ((float)(13D)), ((float)(6D)));
			this.Outlet.Brush = new NxtControl.Drawing.Brush(new NxtControl.Drawing.Color("SE.App2Base.aaLibSymBodyActive"));
			this.Outlet.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Regular);
			this.Outlet.Name = "Outlet";
			this.Outlet.Pen = new NxtControl.Drawing.Pen(new NxtControl.Drawing.Color("SymStaticIconColor"), 1F, NxtControl.Drawing.DashStyle.Solid);
			// 
			// abnormal
			// 
			this.abnormal.BeginInit();
			this.abnormal.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 75D, 63D);
			this.abnormal.Name = "abnormal";
			this.abnormal.EndInit();
			// 
			// alarmFrame
			// 
			this.alarmFrame.Bounds = new NxtControl.Drawing.RectF(((float)(14D)), ((float)(21D)), ((float)(108D)), ((float)(149D)));
			...
			this.SMeters.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, -13D, 12D);
			...
			this.failure.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 78D, 25D);
			...
			this.interlock.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 44D, 25D);
			...
			this.permissive.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 61D, 25D);
			...
			this.state.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 54D, 75D);
			...
			this.owner.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 70D, 75D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(18D)), ((float)(5D)), ((float)(100D)), ((float)(13D)));
			...
			this.UpdateOptionalService += new SE.App2Base.Symbols.SEAppLibHMISymbol.OnUpdateOptionalService(this.SPumpUpdateOptionalService);
		...
		private NxtControl.GuiFramework.Arc arcFwd;
