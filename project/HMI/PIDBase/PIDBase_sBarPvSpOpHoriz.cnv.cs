...
namespace HMI.Main.Symbols.PIDBase
{
	...
	public partial class sBarPvSpOpHoriz : SE.App2Base.Symbols.SEAppLibHMISymbol,SE.App2CommonProcess.SupportClasses.IPropertiesNotifyChange
	{
		...
		NxtControl.Drawing.PointF PvSpIlckGrpLocation = new NxtControl.Drawing.PointF(153, 27);
		NxtControl.Drawing.PointF PvSpInstGrpLocation = new NxtControl.Drawing.PointF(48, 14);
		NxtControl.Drawing.PointF OpIlckGrpLocation = new NxtControl.Drawing.PointF(153, 59);
		NxtControl.Drawing.PointF OpInstGrpLocation = new NxtControl.Drawing.PointF(47, 46);
		...
		void SetView()
		{
			switch (DisplayType) {
				case PidDisplayType.PvSpOp:
					...
					owner.Location = new NxtControl.Drawing.PointF(PvSpIlckGrpLocation.X + 17, PvSpIlckGrpLocation.Y + 1);
				...
				default:
					...
					owner.Location = new NxtControl.Drawing.PointF(OpIlckGrpLocation.X + 17, OpIlckGrpLocation.Y + 1);
		...
		void SBarPvSpOpHorizUpdateOptionalService(string instancePath)
		{
