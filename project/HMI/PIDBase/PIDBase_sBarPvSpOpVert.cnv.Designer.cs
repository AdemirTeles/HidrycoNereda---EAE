...
namespace HMI.Main.Symbols.PIDBase
{
	...
	partial class sBarPvSpOpVert
	{
		...
		private void InitializeComponent()
		{
			...
			this.PvSpGroup.AbnormalXOffset = -20D;
			this.PvSpGroup.AbnormalYOffset = 2D;
			this.PvSpGroup.BarGraphSize = 100D;
			this.PvSpGroup.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 36D, 30D);
			this.PvSpGroup.display = SE.App2Base.Graphics.SMeters.Display.BarGraph;
			...
			this.PvSpGroup.RangeVisible = SE.App2Base.SupportClasses.BoolType.False;
			this.PvSpGroup.Rotation = SE.App2Base.SupportClasses.Rotation.Vertical;
			...
			this.OpGroup.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 65D, 28D);
			this.OpGroup.display = SE.App2Base.Graphics.SMeters.Display.BarGraph;
			...
			this.OpGroup.RangeVisible = SE.App2Base.SupportClasses.BoolType.False;
			this.OpGroup.Rotation = SE.App2Base.SupportClasses.Rotation.Vertical;
			...
			this.OpGroup.TextLocationPvSpOp = SE.App2Base.Graphics.SMeters.TextLocation.Right;
			this.OpGroup.Unit = "%";
			...
			this.interlock.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 48D, 33D);
			...
			this.owner.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 48D, 49D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(33D)), ((float)(9D)), ((float)(100D)), ((float)(13D)));
			...
			// clickFrame
			// 
			this.clickFrame.Bounds = new NxtControl.Drawing.RectF(((float)(75D)), ((float)(85D)), ((float)(40D)), ((float)(29D)));
			...
			this.InstanceName,
			this.clickFrame});
			this.SymbolSize = new System.Drawing.Size(160, 208);
			this.UpdateOptionalService += new SE.App2Base.Symbols.SEAppLibHMISymbol.OnUpdateOptionalService(this.SBarPvSpOpVertUpdateOptionalService);
