...
{
	/// <summary>
	/// Summary description for sBarPvSpOp.
	/// </summary>
	partial class sBarPvSpOpHoriz
	{
		...
		private void InitializeComponent()
		{
			...
			this.PvSpGroup.AbnormalXOffset = -6D;
			this.PvSpGroup.AbnormalYOffset = -10D;
			this.PvSpGroup.BarGraphSize = 96D;
			this.PvSpGroup.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 17D, -53D);
			...
			this.OpGroup.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 17D, -5D);
			...
			this.interlock.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 153D, 31D);
			...
			this.owner.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 153D, 47D);
			...
			this.InstanceName.Bounds = new NxtControl.Drawing.RectF(((float)(48D)), ((float)(9D)), ((float)(100D)), ((float)(13D)));
			...
			// clickFrame
			// 
			this.clickFrame.Bounds = new NxtControl.Drawing.RectF(((float)(67D)), ((float)(54D)), ((float)(77D)), ((float)(29D)));
			...
			this.InstanceName,
			this.clickFrame});
			this.SymbolSize = new System.Drawing.Size(216, 144);
			this.UpdateOptionalService += new SE.App2Base.Symbols.SEAppLibHMISymbol.OnUpdateOptionalService(this.SBarPvSpOpHorizUpdateOptionalService);
