...
{
	/// <summary>
	/// Description of sPvSpOp.
	/// </summary>
	public partial class sDisplayPvSpOp : SE.App2Base.Symbols.SEAppLibHMISymbol,SE.App2CommonProcess.SupportClasses.IPropertiesNotifyChange
	{
		PIDUnit unit;
		PIDDecimalPlacesCount decimalPlacesCount;
		public sDisplayPvSpOp()
		{
			//
		...
		NxtControl.Drawing.PointF PvSpIlckGrpLocation=  new NxtControl.Drawing.PointF(113,34);
		NxtControl.Drawing.PointF PvSpInstGrpLocation =  new NxtControl.Drawing.PointF(29,7);
		NxtControl.Drawing.PointF OpIlckGrpLocation=  new NxtControl.Drawing.PointF(113,66);
		NxtControl.Drawing.PointF OpInstGrpLocation =  new NxtControl.Drawing.PointF(29,50);
		...
		public void SetView()
		{
			switch (DisplayType) {
				case PidDisplayType.PvSpOp:
					...
					owner.Location = new NxtControl.Drawing.PointF(PvSpIlckGrpLocation.X-2,PvSpIlckGrpLocation.Y+17);
					InstanceName.Location = PvSpInstGrpLocation;
					clickFrame.Location = PvSpGroup.Location;
					clickFrame.Size = new NxtControl.Drawing.SizeF(PvSpGroup.Size.Width,PvSpGroup.Size.Height + OpGroup.Size.Height);
					break;
				...
				default:
					...
					owner.Location = new NxtControl.Drawing.PointF(OpIlckGrpLocation.X-2,OpIlckGrpLocation.Y+17);
		...
		void SDisplayPvSpOpUpdateOptionalService(string instancePath)
		{
